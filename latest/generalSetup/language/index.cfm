...
<head>
    ...
    <script type="text/javascript" src="/latest/js/generalSetup/languages/language.js"></script>
		...
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10412_3a EQ 'T'>
                	<button type="button" class="btn btn-default" onclick="window.open('/latest/generalSetup/language/language.cfm?action=create','_self');">
