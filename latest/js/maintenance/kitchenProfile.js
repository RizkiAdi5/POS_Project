                ...
                { 'aTargets': [1], 'sTitle': 'NAME',       'mData': 'name',      'bSortable': true, 'sWidth': '50%' },
                {
                    ...
                    'mRender': function(data, type, row) {
                        return '<span class="glyphicon glyphicon-pencil btn btn-link" ' +
                               ...
                               'onclick="if(confirm(\'Delete this kitchen staff?\\')){window.open(\'/latest/maintenance/kitchenProcess.cfm?action=delete&kitchenID=' + escape(encodeURIComponent(data)) + '\',\'_self\');}"></span>';
                    }
                }
            ],
            'bAutoWidth': false,
