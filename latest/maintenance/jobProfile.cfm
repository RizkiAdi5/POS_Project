...
<cfset words_id_list = "474,475,65,10,11,476,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[474]#">
<cfset targetTitle="Job">
<cfset targetTable=#target_project#>
<cfset displayEditDelete=getUserPin2.H10319d_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/jobProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10319d_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/job.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[476]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10319d_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/jobProcess.cfm?action=print','_blank');">
