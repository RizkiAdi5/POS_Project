<cfset pageTitle="Opening Quantity Profile">
<cfset targetTitle="Opening Quantity Profile">
<cfset targetTable="locqdbf">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/openingQuantityProfile.js"></script>
