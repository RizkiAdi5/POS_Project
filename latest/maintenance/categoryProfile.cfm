...
<cfset words_id_list = "358,123,65,10,11,359,3">
<cfinclude template="/latest/words.cfm">
<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset targetTitle="Category">
<cfset targetTable="iccate">
<cfset pageTitle="#words[358]#">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/categoryProfile.js"></script>
		...
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10201_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/category.cfm?action=create&menuID=#url.menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[359]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10201_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/categoryProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
