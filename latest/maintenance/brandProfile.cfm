...
<cfset words_id_list = "122,65,10,11,354,3">
<cfinclude template="/latest/words.cfm">

<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset targetTitle="Brand">
<cfset targetTable="brand">
<cfset displayEditDelete=getUserPin2.H10207_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/brandProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10207_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/brand.cfm?action=create&menuID=#menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span>  #words[354]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10207_3c EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/brandProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
