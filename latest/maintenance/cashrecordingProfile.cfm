<cfset pageTitle="Cash Recording Profile">
<cfset targetTitle="Cash Recording">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/cashrecordingProfile.js"></script>
		...
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10412_3a EQ 'T'>
                	<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/cashrecording.cfm?action=create','_self');">
