<cfset pageTitle="ColorSize Profile">
<cfset targetTitle="ColorSize">
<cfset targetTable="iccolor2">
<cfset displayEditDelete=getUserPin2.H10413_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/colorSizeProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10413_3a EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/colorSize.cfm?action=create','_self');">
						<span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
					</button>
                </cfif>
                <cfif getUserPin2.H10413_3c EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/colorSizeProcess.cfm?action=print','_blank');">
