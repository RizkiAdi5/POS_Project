...
<cfset words_id_list = "569,571,23,10,11,570,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[569]#">
<cfset targetTitle="Cashier">
<cfset targetTable="cashier">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var cashierid='#words[571]#';
        var name='#words[23]#';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/cashierProfile.js"></script>
		...
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10412_3a EQ 'T'>
                	<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/cashier.cfm?action=create','_self');">
                    	<span class="glyphicon glyphicon-plus"></span> #words[570]#
                	</button>
            	</cfif>
                <cfif getUserPin2.H10412_3c EQ 'T'>
                	<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/cashierProcess.cfm?action=print','_blank');">
