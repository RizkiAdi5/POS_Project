<cfcomponent>
    <cffunction name="listAccount" access="remote" returntype="struct">
        ...
        <cfquery name="listMatchedAccount" datasource="#dts#">
            SELECT cate AS cate , desp AS desp
            FROM iccate
            WHERE cate LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#term#%" />
        ...
        <cfloop query="listMatchedAccount">
            ...
            <cfset matchedAccount["id"]=evaluate('listMatchedAccount.cate')>
            <cfset matchedAccount["category"]=evaluate('listMatchedAccount.cate')>
    ...
    <cffunction name="getSelectedAccount" access="remote" returntype="struct">
        ...
        <cfset matchedAccount["id"]=evaluate('listMatchedAccount.cate')>
        <cfset selectedAccount["category"]=evaluate('getSelectedAccount.cate')>
