...
<cfset words_id_list = "363,146,65,10,11,364,3">
<cfinclude template="/latest/words.cfm">

<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset targetTitle="Group">
<cfset targetTable="icgroup">
<cfset displayEditDelete=getUserPin2.H10202_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/groupProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10202_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/group.cfm?action=create&menuID=#menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[364]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10202_3c EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/groupProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
