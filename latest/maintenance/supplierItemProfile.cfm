<cfset pageTitle="Supplier/Item Price ">
<cfset targetTitle="Supplier/Item Price">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var targetTable='#target_apvend#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/supplierItemProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/supplierItemPrice.cfm?action=create','_self');">
                    <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                </button>
                
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/supplierItemProcess.cfm?action=print','_blank');">
