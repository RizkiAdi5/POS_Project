<cfset pageTitle="Attention Profile">
<cfset targetTitle="Attention">
<cfset targetTable="attention">
<cfset displayEditDelete=getUserPin2.H10411_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/attentionProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10411_3a EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/attention.cfm?action=create','_self');">
						<span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
					</button>
            	</cfif>
                <cfif getUserPin2.H10411_3c EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/attentionProcess.cfm?action=print','_blank');">
