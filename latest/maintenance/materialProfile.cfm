...
<cfset words_id_list = "383,148,65,10,11,384,3">
<cfinclude template="/latest/words.cfm">
<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset targetTitle="Material">
<cfset targetTable="iccolorid">
<cfset pageTitle = "#words[383]#">
<cfset displayEditDelete=getUserPin2.H10205_3b>
...
<head>
    ...
    <script type="text/javascript">
		...
		var material='#words[148]#';
		var description='#words[65]#';
		var action='#words[10]#';
		var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/materialProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10205_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/material.cfm?action=create&menuID=#url.menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[384]#
                    </button>
                </cfif>    
				<cfif getUserPin2.H10205_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/materialProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
