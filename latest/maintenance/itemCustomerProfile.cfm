<cfset pageTitle="Item/Customer Price ">
<cfset targetTitle="Item/Customer Price">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/itemCustomerProfile.js"></script>
