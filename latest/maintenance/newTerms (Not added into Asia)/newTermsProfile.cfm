<cfset pageTitle="New Terms Profile">
<cfset targetTitle="New Terms">
<cfset targetTable="termsAndConditions">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/newTerms/newTermsProfile.js"></script>
...
<div class="container">
	<div class="page-header">
		<h2>
			...
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/newTerms/newTerms.cfm?action=create','_self');">
				<span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
			</button>
            
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/newTerms/newTermsProcess.cfm?action=print','_blank');">
