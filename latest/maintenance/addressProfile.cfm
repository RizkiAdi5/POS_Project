<cfset pageTitle="Address Profile">
<cfset targetTitle="Address">
<cfset targetTable="address">
<cfset displayEditDelete=getUserPin2.H10312_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/addressProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10312_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/address.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10312_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/addressProcess.cfm?action=print','_blank');">
