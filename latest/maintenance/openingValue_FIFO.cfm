<cfset pageTitle="Opening Value with FIFO">
<cfset targetTitle="Opening Value with FIFO">
<cfset targetTable="fifoopq">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/openingValue_FIFO.js"></script>
