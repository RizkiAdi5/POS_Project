...
<cfset words_id_list = "388,150,65,10,11,389,3">
<cfinclude template="/latest/words.cfm">
<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset targetTitle="Model">
<cfset targetTable="vehimodel">
<cfset pageTitle = "#words[388]#">
<cfset displayEditDelete=getUserPin2.H10206_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/modelProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10206_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/model.cfm?action=create&menuID=#url.menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[389]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10206_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/modelProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
