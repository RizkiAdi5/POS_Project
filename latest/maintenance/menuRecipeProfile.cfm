...
<cfset words_id_list = "10,11">
<cfinclude template="/latest/words.cfm">
<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset pageTitle = "Menu Recipe (BOM) Profile">
<cfset displayEditDelete=getUserPin2.H70002_3b>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var itemCodeLabel='Item Code';
        var itemNameLabel='Item Name';
        var recipeCountLabel='Ingredients';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/menuRecipeProfile.js"></script>
...
<div class="container">
	<div class="page-header">
		...
		<p class="text-muted">Click the edit icon on any item to define which raw materials it consumes per unit sold.</p>
	</div>
	<div class="container">
