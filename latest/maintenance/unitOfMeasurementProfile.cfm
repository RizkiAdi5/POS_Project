...
<cfset words_id_list = "541,492,65,10,11,542,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[541]#">
<cfset targetTitle="Unit of Measurement">
<cfset targetTable="unit">
<cfset displayEditDelete=getUserPin2.H10319f_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/unitOfMeasurementProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10319f_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/unitOfMeasurement.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[542]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10319f_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/unitOfMeasurementProcess.cfm?action=print','_blank');">
