...
<cfset pageTitle = "Raw Material Usage Report">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var usedAtLabel='Date / Time';
        var orderLabel='Order';
        var itemLabel='Menu Item';
        var materialLabel='Raw Material';
        var qtyLabel='Qty Used';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/materialUsageReport.js"></script>
...
<div class="container">
	<div class="page-header">
		<h2>#pageTitle#</h2>
		<p class="text-muted">Every raw-material deduction, one row per ingredient consumed when a kitchen item moves to "Preparing"/"Ready".</p>
	</div>
	<div class="container">
