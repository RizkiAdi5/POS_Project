...
<cfset words_id_list = "450,452,65,10,11,451,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[450]#">
<cfset targetTitle="Business">
<cfset targetTable="business">
<cfset displayEditDelete=getUserPin2.H10318_3b>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var business='#words[452]#';
        var description='#words[65]#';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/businessProfile.js"></script>
        ...
        <div class="page-header">
            <h2>
                ...
                <div class="pull-right">
					<cfif getUserPin2.H10318_3a EQ 'T'>
                        <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/business.cfm?action=create','_self');">
                            <span class="glyphicon glyphicon-plus"></span> #words[451]#
                        </button>
                    </cfif>
                    <cfif getUserPin2.H10318_3a EQ 'T'>
                        <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/businessProcess.cfm?action=print','_blank');">
