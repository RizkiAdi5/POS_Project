...
<cfset defaultfontsize = "12px">
    ...
    Select Servi as itemno, desp,0 as ucost,0 as price,'' as aitemno,'' as wos_group,'' as category,'' as sizeid,'' as colorid,0 as price2,'' as remark6,'' as remark7,'' as remark8,'' as remark9,'' as remark10,'' as remark11 from icservi WHERE
    1=1 
    ...
    union all
    select itemno,desp,ucost,price,aitemno,wos_group,category,sizeid,colorid,price2,remark6,remark7,remark8,remark9,remark10,remark11 from icitem WHERE 
    1=1
    <cfif URLDECODE(url.itemno) neq "">
    ...
    <cfif lcase(hcomid) eq "tcds_i">order by sizeid,colorid<cfelse>order by itemno</cfif> limit 200
	</cfquery>
    ...
    <cfif getdisplay.itemsearch_qty eq 'Y'>
    <cfif lcase(hcomid) eq "tcds_i">
    <td align="center"><cfif getgsetup.ddllocation eq 'GWC'>#getitembalance1.balance#<cfelse>#remark6#</cfif></td>
    <td align="center"><cfif getgsetup.ddllocation eq 'RF'>#getitembalance1.balance#<cfelse>#remark7#</cfif></td>
    <td align="center"><cfif getgsetup.ddllocation eq 'PP'>#getitembalance1.balance#<cfelse>#remark8#</cfif></td>
    <td align="center"><cfif getgsetup.ddllocation eq 'MBS'>#getitembalance1.balance#<cfelse>#remark9#</cfif></td>
