...
<cfset words_id_list = "2131, 805, 30, 702, 1087, 1303, 2058, 585, 2057, 482, 1330, 786, 1335, 592, 1294, 1099, 1733, 1331, 1082, 592, 98, 2059, 1336, 2060,
58, 274, 65, 227, 1096, 592, 1097, 10, 1302, 1297, 2062, 2063, 1347, 96, 2061, 1349, 1520, 2072, 2082, 2083, 2084, 2085, 2086, 2087, 2088, 2089, 2090,
2091, 2092, 2093, 2094, 2095, 2096, 2097, 2098, 2099, 2100, 2101, 2102, 2103, 2104, 2105, 2106, 2107,2108, 2109, 2110, 2111, 492, 2133">
...
function selectmemberlist(driverno){
  ...
  for(var i=0;i<output.length;i++) {
	...
	function updaterow(rowno)
	{
		...
		var updateurl = 'updaterow.cfm?uuid='+escape(uuid)+'&trancode='+rowno+'&unit='+escape(unitlistdata);
	...
	function submitpay()
	{
		...
		{
			ColdFusion.Window.show('choosecashier');
			if(paytypeno==0){
...
<!--- 	for (k=1;k<=200;k=k+1)
	...
	window.location.href="index.cfm?uuid="+newuuid+"&counter="+document.getElementById("counterinfo").value+"&cashier="+document.getElementById("cashierinfo").value;
	}
	}
	</cfoutput>
	var t1;
	...
	function itemcheckbox(itembox)
	{
		...
		var actionpick = 'delete';
			...
			var updateurl = 'pickitemlist.cfm?action='+actionpick+'&uuid='+escape(document.getElementById('pickitemuuid').value)+'&itemno='+escape(encodeURIComponent(itembox.value));
				new Ajax.Request(updateurl,
			  {
				method:'get',
				onSuccess: function(getdetailback){
	...
	document.getElementById('expunit').value =document.getElementById('unithid').value;
	document.getElementById('itemserialno').value=document.getElementById('itemserialnohid').value;
...
<!--- 	if(document.getElementById('btn_add').value == "Add")
	...
	try
	{
	document.getElementById('expqty').value = document.getElementById('qtyhid').value;
	document.getElementById('expressamt').value = document.getElementById('amthid').value;
	}
	catch(err)
	{
	var expqty = trim(document.getElementById('expqty').value);
...
<cfoutput>
	...
	var expressservice=encodeURIComponent(trim(document.getElementById('expressservicelist').value));
	var desp = encodeURIComponent(document.getElementById('desp2').value);
	...
	document.getElementById('itemserialno').value = '';
	document.getElementById('expressservicelist').focus();;
	...
	{
    var urlloaditemdetail = '/default/transaction/POS/addItemAjax.cfm?itemno='+escape(encodeURIComponent(detailitemno))+'&reftype='+document.getElementById('tran').value+'&uuid='+document.getElementById('uuid').value;
	<!---alert(1);
	...
	document.getElementById('expressservicelist').value=detailitemno;
	document.getElementById('expqty').value=1;
	...
	{
	  var urlloaditembal = '/default/transaction/POS/balonhand.cfm?itemno='+encodeURIComponent(itemnobal)+'&location='+escape(document.getElementById('locationfr').value);
	...
	{
	document.getElementById('gross').value = (document.getElementById('hidsubtotal2').value*1).toFixed(2);
	<cfif getgsetup.wpitemtax eq "1">
	document.getElementById('taxamt').value = (document.getElementById('hidtaxtotal2').value*1).toFixed(2);
	</cfif>
	...
	{
		alert("#words[2101]#"+document.getElementById('minimumprice2').value);
	}
	...
	{
    var urlloaditemdetail = '/default/transaction/POS/changediscountprocess.cfm?trancode='+trancode+'&uuid='+uuid+'&disamt_bil1='+discount+'&disp1='+disp1+'&disp2='+disp2+'&disp3='+disp3;
	...
	var answer = confirm("#words[2109]#");

	if(answer)
	{
	window.location.href="index.cfm"+"?counter="+document.getElementById("counterinfo").value+"&cashier="+document.getElementById("cashierinfo").value;
	}
	}

	function closetran()
	{
	var answer = confirm("#words[2110]#");
	if(answer)
	{
	window.close();
	}
	...
	function ctrl1()
	{
	var answer = confirm("#words[2111]#");
	if(answer)
	{
	var onholdurl = '/default/transaction/POS/onholdajax.cfm?uuid='+document.getElementById("uuid").value+'&remark='+document.getElementById("rem9").value+'&cashier='+document.getElementById("cashierinfo").value;
	ajaxFunction(document.getElementById('onholdajax'),onholdurl);
	...
	function ctrl7()
	{
	window.open('timemanchine.cfm?uuid='+escape(document.getElementById("uuid").value)+'&counter='+document.getElementById("counterinfo").value+'&cashier='+document.getElementById("cashierinfo").value, '',opt);
	}

	function taxincludeditemfunc()
	{
	var uuid=document.getElementById('uuid').value;
	if(document.getElementById('taxinclitem').checked ==true)
	{
	var urlloaditemdetail = '/default/transaction/POS/updateitemtax.cfm?uuid='+uuid+'&taxincluded=1';
	}
	else
	{
	var urlloaditemdetail = '/default/transaction/POS/updateitemtax.cfm?uuid='+uuid+'&taxincluded=';
...
<!--- --->
<table width="100%" height="100%"  style="background-image:url(top-01.jpg);background-size: 100% 21%;background-repeat: no-repeat;">
<tr>
<td width="70%" height="100%">
<table width="100%" height="100%" >
<tr>
<td height="20%">
<table width="100%" height="100%" ><!---  style="background-color:##C6C5CD;" --->
<tr>
<td>
<font style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#"><strong>#words[702]#</strong></font><br>
<cfset datenow=now()>
...
<font style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#"><strong>#words[1087]#</strong></font><br>
...
<tr>
<td>
<font style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#"><strong>#words[1303]#</strong></font><br>
...
SELECT "#words[1520]#" as eudesp, "" as DRIVERNO
union all
...
<cfif lcase(hcomid) neq 'tcds_i'><a style="cursor:pointer" onClick="ColdFusion.Window.show('neweu')">#words[1331]#</a></cfif> <input type="hidden" name="driverhid" id="driverhid"> &nbsp;&nbsp;
<br>
...
<tr>
<td><strong>#words[585]#/#words[2057]#</strong><br>
<cfset counter = "">
  <cfset cashier = "">
  ...
  <cfinput type="text" name="cashierinfo" id="cashierinfo" value="#cashier#" readonly="" style="border:none; background-color:transparent">
</td>
<td><strong>#words[482]#</strong><br>
...
<td nowrap>
#words[1302]#
  <cfif lcase(hcomid) eq "ipointfortune_i">
<cfinput type="text" name="expressservicelist" style="font: x-large bolder" id="expressservicelist" size="20"  onKeyUp="nextIndex(event,'expressservicelist','expressservicelist');" value="#words[2072]#" />
<cfelse>
<cfif getgsetup.hideqty eq 'Y'>
<cfinput type="text" name="expressservicelist" style="font: x-large bolder" id="expressservicelist" size="20"  onKeyUp="nextIndex(event,'expressservicelist','expressservicelist');" />
<cfelse>
<cfinput type="text" name="expressservicelist" style="font: x-large bolder" id="expressservicelist" size="20" onBlur="getitemdetail(this.value);" onKeyUp="nextIndex(event,'expressservicelist','expqty');" />
</cfif>
</cfif>
...
<!--- <input type="button" id="searchitembtn" style="font: medium bolder" onClick="ColdFusion.Window.show('searchitem');getfocus2();" value="#getpayment.scsearch# Search" align="right" />
 ---><a style="cursor:pointer" onClick="ColdFusion.Window.show('searchitem');getfocus2();"><img src="Search.gif" height="20" width="20"></a></td>
<td >

<input type="hidden" name="desp2" id="desp2" size="40" onKeyUp="nextIndex(event,'desp','expqty');" >
<cfif getgsetup.hideqty eq 'Y'>
<input type="hidden" style="font: x-large bolder" name="expqty" id="expqty" size="3" maxlength="10" value="1" onKeyUp="calamtadvance();nextIndex(event,'expqty','expprice');<cfif getgsetup.expressdisc neq "1">document.getElementById('expqtycount').value = this.value;</cfif>" >
<cfelse>
#words[227]#       <input type="text" style="font: x-large bolder" name="expqty" id="expqty" size="3" maxlength="10" value="1" onKeyUp="calamtadvance();nextIndex(event,'expqty','expprice');<cfif getgsetup.expressdisc neq "1">document.getElementById('expqtycount').value = this.value;</cfif>" >
</cfif>
<input name="btn_add" style="font: medium bolder" id="btn_add" type="hidden" value="Add" onClick="additembtn();">
...
<input type="hidden" name="itemserialno" id="itemserialno" value="">
</td>
<td width="30%">
<cfif getgsetup.setitemdiscount eq 'Y'>
  ...
  <option value="0%">#words[592]#</option>
  <cfloop query="getdiscount">
  <option value="#getdiscount.discount#%">#getdiscount.discount#%</option>
  </cfloop>
  </select>&nbsp;&nbsp;&nbsp;<input type="button" name="updatebodydisc" id="updatebodydisc" value="#words[98]#" onClick="updatebodydisclist();"></cfif>
</td>
</tr>
</table>
...
<tr style="display:none">
  <th><font style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#">#words[592]#</font></th>
  <td colspan="2">
  <cfif getgsetup.expressdisc eq "1">
...
<td nowrap><font style="font-size:14px">#getictrantemp.itemno#</font><cfif wserialno eq "T">&nbsp;&nbsp;<input type="button" name="addserial" id="addserial" value="S" onClick="PopupCenter('serial.cfm?tran=#type#&nexttranno=#refno#&itemno=#URLEncodedFormat(itemno)#&itemcount=#trancode#&uuid=#uuid#&qty=#qty#&custno=#custno#&price=#price#&location=#URLEncodedFormat(location)#','Add Serial','200','100');"></cfif></td>
...
<tr>
<td colspan="100%" height="25%" ><!--- style="background:##7F7F7F; color:##FFF; margin-top:30px;" --->

<br>
<div align="right"><font size="+3"><strong>#words[1330]#&nbsp;</strong></font></div>
<br><br><!--- background-color:##7F7F7F; --->
<div align="right"><cfinput type="button" style="font-size:50px; color:##FFF; background-color:transparent; height:56; text-align:right;" name="grand2" id="grand2" value="0.00" onClick="calculatefooter();" />&nbsp;&nbsp;</div>
<cfinput type="hidden" style="font: large bolder; color:##000; " name="grand" id="grand" value="0.00" onClick="calculatefooter();" />&nbsp;&nbsp;<br>
...
<input type="button" id="searchitembtn" style="font: medium bolder" onClick="ColdFusion.Window.show('findRefno');" value="#words[2059]#" align="right" />&nbsp;&nbsp;
<input type="button" id="searchitembtn" style="font: medium bolder" onClick="ctrl1();" value="#words[1336]#" align="right" />&nbsp;&nbsp;
<input type="button" id="searchitembtn" style="font: medium bolder" onClick="ctrl7();" value="#words[2060]#" align="right" />
</tr>
...
<font style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#"><strong>#words[786]# : #getsumictrantemp.sumqty#</strong></font>
</div></td>
</tr>
...
<tr height="20%">
<td width="100px"><strong>#words[1335]#</strong></td>
...
<tr>
<td><strong>#words[1733]#</strong></td>
...
<input name="pay_btn" style="font: large bolder;background-color:##f58c3d; color:##FFF; height:40; width:150;" id="btn_add" type="button" value="#words[1297]#" onClick="document.getElementById('paytype').value='0';document.getElementById('mod').value='=0&grandtotal='+document.getElementById('grand').value+'&uuid='+document.getElementById('uuid').value;gopay('totalup');getfocus10();" size="15" />

<cfif getpayment.creditcard eq "Y">
&nbsp;&nbsp;&nbsp;<input name="pay_btn" style="font: large bolder;background-color:##a86e4d; color:##FFF; color:##FFF; height:40; width:150;" id="btn_add" type="button" value="#words[2062]#" onClick="document.getElementById('paytype').value='2';document.getElementById('mod').value='=0&grandtotal='+document.getElementById('grand').value+'&uuid='+document.getElementById('uuid').value;gopay('totalup2');getfocus12();">
</cfif>
<!--- <cfif getpayment.deposit eq "Y">
<br><br><input name="adddeposit" style="font: large bolder;background-color:##6C0; color:##FFF; height:40; width:150;" id="adddeposit" type="button" value="Add Deposit" onClick="window.open('/default/transaction/deposit/Deposittable2.cfm?type=Create&tran=1&sono='+document.getElementById('refno').value,'_blank')"  />
</cfif> --->
<cfif getpayment.nets eq "Y">
<br><br><input name="pay_btn" style="font: large bolder;background-color:##e85c5c; color:##FFF; height:40; width:150;" id="btn_add" type="button" value="#words[2063]#" onClick="document.getElementById('paytype').value='1';document.getElementById('mod').value='=0&grandtotal='+document.getElementById('grand').value+'&uuid='+document.getElementById('uuid').value;gopay('totalup1');getfocus11();" >
</cfif>
&nbsp;&nbsp;&nbsp;<input name="pay_btn" style="font: large bolder;background-color:##2ea6c4; color:##FFF; height:40; width:150;" id="btn_add" type="button" value="#words[1347]#" onClick="document.getElementById('paytype').value='5';document.getElementById('mod').value='=0&grandtotal='+document.getElementById('grand').value+'&uuid='+document.getElementById('uuid').value;gopay('totalup5');getfocus15();" size="15" />
...
<br><br><input name="cancel" style="font: large bolder; height:40; width:150; color:##FFF;" id="cancel" type="button" value="#words[96]#" onClick="canceltran();" size="15" />

&nbsp;&nbsp;&nbsp;<input name="close" style="font: large bolder; background-color:##8AB82E; height:40; width:150; color:##FFF;" id="close" type="button" value="#words[2133]#" onClick="window.close();" size="15" />
...
<cfwindow  width="800" height="600" name="totalup5" refreshOnShow="true"  modal="true" title="Total" initshow="false" source="total5.cfm?driverno={driver}&{mod}" />
...
<cfwindow  width="800" height="800" name="deleterefno" refreshOnShow="true"  modal="true" title="Delete Cash SAles" initshow="false" source="deleteRefno.cfm" />
 ...
 <cfif counter eq "" and cashier eq "">

 <cfif getgsetup.disablecounter eq 'Cashier'>
 <cfwindow  width="350" height="260" name="choosecashier" refreshOnShow="true"  modal="true" title="#words[2061]#" resizable="false" initshow="true" source="choosecashier.cfm" />
 <cfwindow  width="350" height="260" name="choosecounter" refreshOnShow="true"  modal="true" title="#words[1349]#" initshow="false" source="choosecounter.cfm" />
 <cfelseif getgsetup.disablecounter eq 'Disable'>
 <cfwindow  width="350" height="260" name="choosecashier" refreshOnShow="true"  modal="true" title="#words[2061]#" initshow="false" source="choosecashier.cfm" />
 <cfwindow  width="350" height="260" name="choosecounter" refreshOnShow="true"  modal="true" title="#words[1349]#" initshow="false" source="choosecounter.cfm" />
 <cfelse>
 <cfif getgsetup.compulsarycounter eq 'Y'>
 <cfwindow  width="350" height="260" name="choosecounter" resizable="false" refreshOnShow="true"  modal="true" title="#words[2061]#" initshow="true" source="choosecounter.cfm" />
 <cfelse>
 <cfwindow  width="350" height="260" name="choosecounter" refreshOnShow="true"  modal="true" title="#words[1349]#" initshow="true" source="choosecounter.cfm" />
 </cfif>
 </cfif>
 </cfif>
