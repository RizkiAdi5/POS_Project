...
<cfset words_id_list = "965, 123, 121, 65,120, 146, 23, 1096, 1133, 10, 2068">
...
<cfset defaultfontsize = "12px">
    ...
    <input name="Additembtn" id="Additembtn" type="button" style="cursor:pointer;" onClick="addmultiitem();ColdFusion.Window.hide('searchitem');" value="#words[2068]#"/>
    </td>
    </tr>
    <tr>
    ...
    <th width="100px"><font style="text-transform:uppercase">#words[121]#</font></th>
    </cfif>
    <cfif lcase(hcomid) eq "tcds_i">
