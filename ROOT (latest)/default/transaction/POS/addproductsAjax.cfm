...
SELECT itemno,unit,despa FROM ictrantemp WHERE 
trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#validitemexist.trancode#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
</cfquery>
...
<cfif serialno neq "">
	<cfquery name="insertserialno" datasource="#dts#">
    		insert into iserialtemp (type,refno,trancode,custno,itemno,serialno,agenno,location,currrate,sign,price,uuid) 
				values ('#tran#','#tranno#','#trancode#','#custno#'
                ,'#itemno#','#serialno#','','#location#', 
				'1','-1','#price#','#uuid#')
    </cfquery>
</cfif>
...
<cfquery name="getitemdetail" datasource="#dts#">
    select 
    wos_group,category,costcode,custprice_rate,wserialno,taxcode,despa
    from icitem
...
<cfquery name="getitemdetail" datasource="#dts#">
    select 
    wos_group,category,custprice_rate,costcode,wserialno,taxcode,despa
    from icitem
    where itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#">
</cfquery>
