...
<cfform action="editbillcontrolprocess.cfm?tran=#url.tran#&refno=#url.refno#&type=#url.type#" method="post">
...
<h4>Please Key in Supervisor Password for Allow Edit/Delete Bill</h4>
