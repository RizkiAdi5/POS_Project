...
<cfif getitemformat.itemformat eq '2'>
	...
	<cfquery name="getitemno" datasource="#dts#">
   		select itemno as xitemno,desp from icitem WHERE itemno like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.itemno#%"> and desp like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.custname#%"> and aitemno like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.leftcustname#%"> order by itemno limit 500
	</cfquery>
