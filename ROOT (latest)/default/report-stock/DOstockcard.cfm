...
<cfform action="DOstockcard2.cfm" name="form" method="post" target="_blank">
<table border="0" align="center" width="80%" class="data">
	...
	<tr>
		<th>Report Format<cfoutput><input type="hidden" name="tran" id="tran" value="#target_apvend#" /><input type="hidden" name="fromto" id="fromto" value="" /></cfoutput>
</th>
	</tr>
	<tr>
...
<input type="text" name="searchsuppfr" onKeyUp="getSupp('suppfrom','Supplier');">
    ...
    <tr> 
		<th>Category</th>
      <td colspan="7">
      <cfinput type="checkbox" name="cbcate" value="checkbox" >
      </td></tr>
      <tr>
      <th>Brand</th>
      <td><cfinput type="checkbox" name="cbbrand" value="checkbox" ></td>
      </tr>
      <tr>
      <th>Rating</th>
     <td><cfinput type="checkbox" name="cbrating" value="checkbox"></td>
      </tr>
    <tr>
