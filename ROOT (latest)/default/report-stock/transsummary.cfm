...
<cfif type eq "Quantity">
	<form name="transsummary" action="transsummary1.cfm?trantype=#trantype#" method="post" target="_blank">
	
<cfelseif type eq "Value">
	<form name="transsummary" action="transsummary2.cfm?trantype=#trantype#" method="post" target="_blank">
...
<table width="75%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
    ...
    <tr> 
        <th>Date From</th>
        <td><input type="text" name="datefrom" maxlength="10" size="11" onKeyUp="DateFormat(this,this.value,event,false,'3');" onBlur="DateFormat(this,this.value,event,true,'3');"> (DD/MM/YYYY)</td>
    </tr>
    <tr> 
        <th>Date To</th>
        <td><input type="text" name="dateto" maxlength="10" size="11" onKeyUp="DateFormat(this,this.value,event,false,'3');" onBlur="DateFormat(this,this.value,event,true,'3');"> (DD/MM/YYYY)</td>
    </tr>
	<tr> 
