...
<input type="checkbox" name="billtype" id="billtype" value="OAI,OAR" checked>&nbsp;Adjustment<br />
<input type="checkbox" name="billtype" id="billtype" value="RC" checked>&nbsp;Receive & DO<br />
...
<input type="checkbox" name="memberim2" id="memberim2" value="member" checked>&nbsp;Member<br />
</td>
</tr>
