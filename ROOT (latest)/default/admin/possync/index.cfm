...
<link rel="stylesheet" type="text/css" href="/stylesheet/table1.css" />
...
<input type="checkbox" name="billtype" id="billtype" value="RC" checked>&nbsp;Purchase Receive<br/>
</cfif>
...
<input type="checkbox" name="cashierim" id="cashierim" value="cashier" checked>&nbsp;Cashier<br />
...
<input type="checkbox" name="voidbillsim" id="voidbillsim" value="voidbills" checked>&nbsp;Update Void Bill
</td>
</tr>
...
<br />
<input type="checkbox" name="batchupdate" id="batchupdate" value="batchupdate" <cfif lcase(hcomid) eq "gramas_i">onclick="return false;"<cfelse>checked</cfif>> (untick to update all item)
</td>
</tr>
<tr>
<td align="center">
<a href="https://ims.netiquette.asia/latest/posdownloadimage/downloadImages.cfm?cid=#dts#" target="_blank">Download Images</a>
</td>
<td  align="center">
<input type="submit" name="sub_btn" id="sub_btn" value="Sync" onClick="checkboxes();" >
</td>
</tr>
</table>
</form>
