...
<cfoutput>
<h1>
Sync Into Cloud SOSBAT
</h1>
<form action="sosbatprocess.cfm" method="post" onSubmit="return validateform();">
<table>
<tr>
<th>Date From:</th>
...
<input type="checkbox" name="billtype" id="billtype" value="RC" checked>&nbsp;Receive<br/>
...
<input type="checkbox" name="agentim" id="agentim" value="agent" checked>&nbsp;Agent<br />
<input type="checkbox" name="vehicleim" id="vehicleim" value="vehicle" checked>&nbsp;Vehicle<br />
