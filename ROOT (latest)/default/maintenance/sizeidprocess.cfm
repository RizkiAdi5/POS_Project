...
<cfif #form.mode# eq "Create">
	...
	<cfinsert datasource='#dts#' tablename="icsizeid" formfields="sizeid,desp">
		...
		<cfif checkitemExist.recordcount GT 0 >
				...
				<cfif #form.mode# eq "Delete">
						<cfquery datasource='#dts#' name="deleteitem">
								Delete from icsizeid where sizeid='#form.sizeid#'
						</cfquery>
						<cfset status="The #getgeneral.layer#, #form.sizeid# had been successfully deleted. ">	
								
				</cfif>
				<cfif #form.mode# eq "Edit">
					<cfupdate datasource='#dts#' tablename="icsizeid" formfields="sizeid,desp">
