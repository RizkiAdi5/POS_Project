...
<h1>View Supervisor Informations</h1>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="Supervisortable.cfm" method="post">
		<div align="right">Page <cfinput name="skeypage" type="text" size="2" validate="integer" message="Wrong value in Page field.">
			...
			<cfif start neq 1>
				<cfoutput>|| <a href="Supervisortable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
			</cfif>
			<cfif page neq noOfPage>
				<cfoutput> <a href="Supervisortable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
			</cfif>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			...
			<table align="center" class="data" width="450px">
		        ...
		        <td colspan="2">
			        <div align="right"><a href="Supervisortable2.cfm?type=Delete&Supervisor=#URLEncodedFormat(evaluate(strNo))#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete</a> 
			        <a href="Supervisortable2.cfm?type=Edit&Supervisor=#URLEncodedFormat(evaluate(strNo))#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
		        </tr>
				</cfif>
			</table>			
			<br><hr>	
