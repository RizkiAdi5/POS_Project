...
<cfquery name="getVehicles" datasource="#dts#">
  ...
  <cfif form.datefrom neq "" and form.dateto neq "">
	and inexpdate >= '#ndatefrom#' and inexpdate <= '#ndateto#'
  </cfif>
...
<cfswitch expression="HTML">
	<cfcase value="HTML">
		<html>
		<head>
		<title>Vehicle Renewer Report</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfif form.datefrom neq "" and form.dateto neq "">
				<tr>
					<td colspan="9"><div align="center"><font size="2" face="Times New Roman, Times, serif">Insurance Expire Date #form.datefrom# - #form.dateto#</font></div></td>
				</tr>
			</cfif>
  ...
  <cfif #getVehicles.recordCount# neq 0>
    ...
    <cfform action="vehiclerenew2.cfm" method="post">
      <cfoutput>
        <input type="hidden" name="datefrom" value="#form.datefrom#">
        <input type="hidden" name="dateto" value="#form.dateto#">
...
<td align="center" width="9%"><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Insurance Expire Date</cfoutput></font></strong></td>
                        <cfif isdefined("form.cbmodel")>
        <td align="center" width="9%"><strong><font size="2" face="Arial, Helvetica, sans-serif">Model</font></strong></td>
        </cfif>
            <cfif isdefined("form.cbcustname")>
        <td align="center" width="9%"><strong><font size="2" face="Arial, Helvetica, sans-serif">Customer Name</font></strong></td>
        </cfif>
        <cfif isdefined("form.cbcustic")>
      ...
      <cfoutput query="getvehicles" startrow="1">
        <tr>
          ...
          <td align="center" width="9%">#dateformat(inexpdate,'DD-MM-YYYY')#</td>
          <cfif isdefined("form.cbmodel")>
