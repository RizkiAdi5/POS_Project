...
<cfquery name="getcust" datasource="#dts#">
  ...
  <h1 align="center"><cfoutput>Vehicles Renew Report</cfoutput></h1>
<cfoutput>
    <h4 align = "center">
    ...
    <a href="vehiclerenew.cfm">Vehicles Renew Report</a></h4>
  </cfoutput>

<cfform action="vehiclerenew2.cfm" name="form" method="post" target="_blank">
  ...
  <table border="0" align="center" width="90%" class="data">
   ...
   <tr> 
    ...
    <tr> 
      <th>Insurance Expired Date From</th>
        <td colspan= "3">
				<cfoutput>
    ...
    <tr>
      <td colspan="8"><div align="center">
          <h4><font color="#FF3333">Please Tick 7 Fields To Display In The Report</font></h4>
        </div></td>
    </tr>
    <tr> 
      <td colspan="8"><hr></td>
    ...
    <tr> 
      ...
      <td width="5%"><input type="checkbox" name="cbmodel" value="checkbox" onClick="javascript:Tickmodel()"></td>
    ...
    <tr> 
      ...
      <td width="5%"><input type="checkbox" name="cboriregdate" value="checkbox" onClick="javascript:Tickoriregdate()"  checked></td>
