...
<cfquery name="getData" datasource="#dts#">
	...
	(
		Select a.*, b.name as custname, b.name2 as custname2, b.status from Icl3p2 a, #target_arcust# b where a.custno = b.custno group by a.custno order by a.custno
...
<html>
<head>
<title>Recommended Price - Customer/Item</title></title>
...
<!--- <cfquery datasource="#dts#" name="getinfo">
	select * from icl3p2 group by custno order by custno
</cfquery> --->
		...
		<cfif getData.recordcount>
			<cfoutput query="getData">
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<td>#getData.custname# #getData.custname2#</td>
					<td>#getData.status#</td>
					<td align="left">
					<div align="center">
						<a href="itemcustprice2.cfm?type=Delete&custno=#URLEncodedFormat(getData.custno)#&itemno=#URLEncodedFormat(getData.itemno)#&status=#getData.status#">
						<img height="18px" width="18px" src="../../../images/delete.ICO" alt="Delete" border="0">Delete</a>
						<a href="itemcustprice3.cfm?type=Edit&custno=#URLEncodedFormat(getData.custno)#&itemno=#URLEncodedFormat(getData.itemno)#&status=#getData.status#">
