...
<cfquery name="getData" datasource="#dts#">
	...
	(
		Select a.*,b.desp as itemdesp,b.nonstkitem,b.category,b.wos_group,b.brand,b.sizeid,b.colorid,b.shelf,b.costcode,b.ucost from Icl3p2 a, icitem b where a.itemno = b.itemno group by a.itemno order by a.itemno
...
<!--- <cfquery datasource="#dts#" name="getinfo">
	select * from icl3p2 group by itemno order by itemno
</cfquery> --->
		...
		<cfif getData.recordcount>
			<cfoutput query="getData">
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<td align="left">
					<div align="center">
						<a href="custitemprice2.cfm?type=Delete&itemno=#URLEncodedFormat(getData.itemno)#&status=#getData.nonstkitem#"><img height="18px" width="18px" src="../../../images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp;
						<a href="custitemprice3.cfm?type=Edit&itemno=#URLEncodedFormat(getData.itemno)#&status=#getData.nonstkitem#"><img height="18px" width="18px" src="../../../images/edit.ICO" alt="Edit" border="0">Edit</a>
					</div>
					</td> 
				</tr>
			</cfoutput>
