...
<body>
<h1>Recommended Price Selection Page - Item/Supplier</h1></h1>
...
<form action="ssuppitemprice.cfm" method="post">
	<cfoutput>
	<h1>Search By :
...
<cfquery datasource='#dts#' name="type">
	Select a.*,b.desp as xdesp,b.nonstkitem from Icl3p a, icitem b where a.itemno = b.itemno group by a.itemno order by a.itemno
</cfquery>
...
<cfif isdefined("form.searchStr")>
	...
	<cfif exactResult.recordCount neq 0>
		<table align="center" class="data" cellpadding="2" cellspacing="0" width="60%">
			<tr>
			...
			<cfoutput query="exactResult">
				<tr>
					...
					<a href="../icitem/suppitemprice2.cfm?type=Delete&itemno=#URLEncodedFormat(exactResult.itemno)#&status=#exactResult.nonstkitem#">Delete</a>&nbsp;
					<a href="../icitem/suppitemprice3.cfm?type=Edit&itemno=#URLEncodedFormat(exactResult.itemno)#&status=#exactResult.nonstkitem#">Edit</a></div>
					</td>
				</tr>
			</cfoutput>
		</table>
		...
		<table align="center" class="data" cellpadding="2" cellspacing="0" width="60%">
			...
			<cfoutput query="similarResult">
				<tr>
					...
					<td><div align="center">
					<a href="../icitem/suppitemprice2.cfm?type=Delete&itemno=#URLEncodedFormat(similarResult.itemno)#&status=#similarResult.nonstkitem#">Delete</a>&nbsp;
					<a href="../icitem/suppitemprice3.cfm?type=Edit&itemno=#URLEncodedFormat(similarResult.itemno)#&status=#similarResult.nonstkitem#">Edit</a></div></td>
				</tr>
			</cfoutput>
		</table>
	<cfelse>
	...
	<table align="center" class="data" cellpadding="2" cellspacing="0" width="60%">
		...
		<cfoutput query="type" maxrows="20">
			<tr>
				...
				<td><div align="center">
				<a href="../icitem/suppitemprice2.cfm?type=Delete&itemno=#URLEncodedFormat(type.itemno)#&status=#type.nonstkitem#">Delete</a>&nbsp;
				<a href="../icitem/suppitemprice3.cfm?type=Edit&itemno=#URLEncodedFormat(type.itemno)#&status=#type.nonstkitem#">Edit</a></div>
				</td>
			</tr>
