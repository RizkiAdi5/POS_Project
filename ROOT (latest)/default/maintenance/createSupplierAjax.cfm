...
<cfform name="CreateCustomer" id="CreateCustomer" method="post" action="/default/maintenance/createSupplierAjaxProcess.cfm">
<table width="1000px" style="font-size:-2">
<tr>
<th width="200px" align="left">Supplier No.</th>
<td>
...
<cflayoutarea name="Details" title="Details">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <th>Group To</th>
              <td><cfoutput><cfinput type="text" name="groupto" id="groupto" size="20" value="#getgsetup.creditorfr#/000"  /></cfoutput></td>
            </tr>
            <tr>
            <cfoutput>
...
<!---     <tr>
    ...
    <td width="250px"><cfinput type="checkbox" name="ngst_cust" id="ngst_cust" value="T" checked="yes" > Non GST Supplier</td>
    <td width="30px">&nbsp;</td>
    <td width="150px" align="left">&nbsp;</td>
    <td width="220px">&nbsp;</td>
    </tr> --->
    <tr >
      <th align="left">Supplier Type</th>
    ...
    <tr>
      ...
      <cfinput type="radio" name="lc_ex" value="0" checked="yes" > Local Supplier <br />
       <cfinput type="radio" name="lc_ex" value="1" > Export Supplier      </td>
