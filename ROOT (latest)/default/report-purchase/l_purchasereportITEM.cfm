...
<cfquery name="getitem" datasource="#dts#">
  select refno,wos_date,custno,name,qty,unit,price,price_bil,amt_bil,amt,desp,itemno,disamt_bil,disamt from ictran
  where itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URLDECODE(url.itemno)#"> and (type='PR' or type='RC')
     ...
     <cfif lcase(hcomid) eq "vsolutionspteltd_i">
      ...
      <cfoutput query="getitem" startrow="1">
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
         ...
         <cfif lcase(hcomid) eq "vsolutionspteltd_i">
          <td align="right">#getcurrencycode.currcode#</td>
          <td align="right">#lsnumberformat(price_bil,',_.__')#</td>
          <td align="right">#lsnumberformat(amt_bil,',_.__')#</td>
          ...
          <cfif lcase(hcomid) eq "vsolutionspteltd_i">
          <td align="right">#lsnumberformat(disamt,',_.__')#</td></cfif>
