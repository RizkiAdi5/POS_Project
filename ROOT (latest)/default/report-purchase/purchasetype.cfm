...
<html>
<head>
<title>Purchase Report By Type</title>
...
<cfif type eq "producttype">
<form name="salestype" action="purchasetype1.cfm?trantype=#trantype#" method="post" target="_blank">
...
<cfelseif type eq "vendortype">
<form name="salestype" action="vendortype1.cfm?trantype=#trantype#" method="post" target="_blank">
...
<input type="hidden" name="tran" id="tran" value="#target_apvend#" /><input type="hidden" name="fromto" id="fromto" value="" />
		...
		<td>
			...
			<input type="checkbox" name="showqty" value="yes"> With Quantity Purchase
		</td>
	</tr>
	 <tr> 
        <td colspan="5"><hr></td>
