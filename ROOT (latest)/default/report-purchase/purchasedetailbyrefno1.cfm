...
<cfswitch expression="#form.result#">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="9"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>PUCHASE REPORT DETAIL (BY REFNO)</strong></font></div></td>
		</tr>
        <cfif isdefined("form.billfrom") and form.billfrom neq "" and form.billto neq "">
			<tr>
				<td colspan="9"><div align="center"><font size="2" face="Times New Roman, Times, serif">PO: #form.billfrom# - #form.billto#</font></div></td>
			</tr>
		</cfif>
		<cfif isdefined("form.periodfrom") and form.periodfrom neq "" and form.periodto neq "">
			<tr>
        ...
        and a.sono between <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.billfrom#"> and <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.billto#">
        </cfif>
        <cfif trim(form.suppfrom) neq "" and trim(form.suppto) neq "">
				and a.custno >='#form.suppfrom#' and a.custno <= '#form.suppto#'
				</cfif>
