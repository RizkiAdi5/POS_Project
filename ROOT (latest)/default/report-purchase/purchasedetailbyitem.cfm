...
<html>
<head>
<title>Purchase Report Detail By Item</title>
...
<h3>
	...
	<a><font size="2">Print Purchase Report Detail by Item</font></a>
</h3>


<form name="salestype" action="purchasedetailbyitem1.cfm" method="post" target="_blank">
...
<input type="text" name="searchsuppto" onKeyUp="getSupp('suppto','Supplier');">
    ...
    <tr> 
	        <th width="25%">#getgeneral.lPROJECT# From</th>
