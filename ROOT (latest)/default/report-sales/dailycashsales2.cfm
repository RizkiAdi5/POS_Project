	   ...
	   <cfif form.periodfrom neq "" and form.periodto neq "">
		...
		<cfloop query="getagent">
			...
			<cfquery name="getdata" datasource="#dts#">
					select * from artran
					where type='CS' and wos_date = #getagent.wos_date# and (void = '' or void is null)
            ...
            <cfquery name="getqty" datasource="#dts#">
            select sum(qty) as qty from ictran where refno='#getdata.refno#' and type='#getdata.type#'
            </cfquery>
            <cfquery name="getmaster" datasource="#dts#">
			select CS_PM_crcd from artran
			where refno='#getdata.refno#' and type='#getdata.type#'
            and (creditcardtype1='MASTER')
		</cfquery>
        
        <cfquery name="getmaster2" datasource="#dts#">
			select CS_PM_crc2 from artran
			where refno='#getdata.refno#' and type='#getdata.type#'
        ...
        <cfquery name="getvisa2" datasource="#dts#">
            ...
            <cfwddx action = "cfml2wddx" input = "#getdata.refno#" output = "wddxText">
				<Row ss:AutoFitHeight="0">
                    ...
                    <Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getqty.qty)#</Data></Cell>
                    ...
                    <Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getdata.deposit)#</Data></Cell>
                                <cfset subqty = subqty + val(getqty.qty)>
								<cfset totalqty = totalqty + val(getqty.qty)>
                                ...
                                <cfset subcashcd = subcashcd + val(getdata.CS_PM_cashcd)>
								<cfset totalcashcd = totalcashcd + val(getdata.CS_PM_cashcd)>
                                
                                <cfset subnet = subnet + val(getdata.CS_PM_dbcd)>
								<cfset totalnet = totalnet + val(getdata.CS_PM_dbcd)>
                                
                                <cfset subcrcd = subcrcd + val(getvisa.CS_PM_crcd)+val(getvisa2.CS_PM_crc2)>
								<cfset totalcrcd = totalcrcd + val(getvisa.CS_PM_crcd)+val(getvisa2.CS_PM_crc2)>
                                
                                <cfset subcrcd2 = subcrcd2 + val(getmaster.CS_PM_crcd)+val(getmaster2.CS_PM_crc2)>
			...
			<Row ss:AutoFitHeight="0" ss:Height="12">
				<Cell ss:StyleID="s36"/>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#val(subqty)#</Data></Cell>
				<Cell ss:Index="4" ss:StyleID="s37"><Data ss:Type="Number">#subsales#</Data></Cell>
				<Cell ss:StyleID="s37"><Data ss:Type="Number">#subdiscount#</Data></Cell>
				<Cell ss:StyleID="s37"><Data ss:Type="Number">#subtax#</Data></Cell>
				<Cell ss:StyleID="s37"><Data ss:Type="Number">#subgrand#</Data></Cell>
				<Cell ss:StyleID="s37"><Data ss:Type="Number">#subcash#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subnet#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subcashcd#</Data></Cell>
				<Cell ss:StyleID="s37"><Data ss:Type="Number">#subcrcd#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subcrcd2#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subcheque#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subvoucher#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subdeposit#</Data></Cell>
			</Row>
		...
		<Row ss:AutoFitHeight="0" ss:Height="12"/>
	   	<Row ss:AutoFitHeight="0" ss:Height="12">
            ...
            <Cell ss:StyleID="s37"><Data ss:Type="Number">#val(totalqty)#</Data></Cell>
	...
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<tr>
                ...
                <td><font size="2" face="Times New Roman, Times, serif"><div align="right">Quantity</div></font></td>
                ...
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">Amex</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">Diner</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">JCB</font></div></td>
			...
			<cfloop query="getagent">
				...
				<td><font size="2" face="Times New Roman, Times, serif"><strong><u>#dateformat(getagent.wos_date,'DD/MM/YYYY')#</u></strong></font></td>
        ...
        <cfquery name="getdiner" datasource="#dts#">
			select CS_PM_crcd from artran
			where refno='#getdata.refno#' and type='#getdata.type#'
            and (creditcardtype1='DINERS')
		</cfquery>
        
        <cfquery name="getdiner2" datasource="#dts#">
			select CS_PM_crc2 from artran
			where refno='#getdata.refno#' and type='#getdata.type#'
            and (creditcardtype2='DINERS')
		</cfquery>
        
        <cfquery name="getjcb" datasource="#dts#">
			select CS_PM_crcd from artran
			where refno='#getdata.refno#' and type='#getdata.type#'
            and (creditcardtype1='JCB')
		</cfquery>
        
        <cfquery name="getjcb2" datasource="#dts#">
			select CS_PM_crc2 from artran
			where refno='#getdata.refno#' and type='#getdata.type#'
            and (creditcardtype2='JCB')
		</cfquery>
                
					<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                    <td></td>
						<td><div align="left"><font size="2" face="Times New Roman, Times, serif">#getdata.refno#</font></div></td>
                        <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#getqty.qty#</font></div></td>
                                ...
                                <td><div align="right">#numberformat(val(getamex.CS_PM_crcd)+val(getamex2.CS_PM_crc2),',_.__')#</div></td>
                                <td><div align="right">#numberformat(val(getdiner.CS_PM_crcd)+val(getdiner2.CS_PM_crc2),',_.__')#</div></td>
                                <td><div align="right">#numberformat(val(getjcb.CS_PM_crcd)+val(getjcb2.CS_PM_crc2),',_.__')#</div></td>
                                ...
                                <cfset subcrcd3 = subcrcd3 + val(getamex.CS_PM_crcd)+val(getamex2.CS_PM_crc2)>
								<cfset totalcrcd3 = totalcrcd3 + val(getamex.CS_PM_crcd)+val(getamex2.CS_PM_crc2)>
                                
                                <cfset subcrcd4 = subcrcd4 + val(getdiner.CS_PM_crcd)+val(getdiner2.CS_PM_crc2)>
								<cfset totalcrcd4 = totalcrcd4 + val(getdiner.CS_PM_crcd)+val(getdiner2.CS_PM_crc2)>
                                
                                <cfset subcrcd5 = subcrcd5 + val(getjcb.CS_PM_crcd)+val(getjcb2.CS_PM_crc2)>
								<cfset totalcrcd5 = totalcrcd5 + val(getjcb.CS_PM_crcd)+val(getjcb2.CS_PM_crc2)>
				...
				<tr>
                    ...
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#subqty#</strong></font></div></td>
					...
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcash,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subnet,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcashcd,stDecl_UPrice)#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcrcd,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcrcd2,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcrcd3,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcrcd4,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcrcd5,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subcheque,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subvoucher,stDecl_UPrice)#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subdeposit,stDecl_UPrice)#</font></div></td>
				</tr>
				<tr><td><br></td></tr>
			</cfloop>
			<cfflush>
			...
			<tr>
                ...
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong>#numberformat(totalcrcd3,",.__")#</strong></font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong>#numberformat(totalcrcd4,",.__")#</strong></font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong>#numberformat(totalcrcd5,",.__")#</strong></font></div></td>
