...
<html>
<head>
<title>Sales Report Pay Summary</title>
...
<h3>
	...
	<a><font size="2">Print Sales Report Pay Detail</font></a></h3>
...
<cfquery name="getlocation" datasource="#dts#">
	...
	<form name="saleslist" action="salespaydetail1.cfm?alown=#alown#" method="post" target="_blank">
...
<tr>
			...
			<td>
				<select name="locationfrom">
					<cfif HUserGrpID eq 'Super' or getpin2.h4700 neq 'T'>          				<option value="">Choose a <cfoutput>#getgeneral.lLOCATION#</cfoutput></option>
					</cfif>
