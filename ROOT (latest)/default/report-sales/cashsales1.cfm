	...
	<cfcase value="EXCELDEFAULT">
	   ...
	   <cfif form.periodfrom neq "" and form.periodto neq "">
		...
		<cfquery name="getusername" datasource="main">
				select username from users where userbranch='#dts#'
   			    and userid ='#getagent.userid#'
		</cfquery>
			<cfwddx action = "cfml2wddx" input = "#getagent.userid#" output = "wddxText1">
			<cfwddx action = "cfml2wddx" input = "#getusername.username#" output = "wddxText2">
			...
			<cfquery name="getdata" datasource="#dts#">
					select * from artran
					where type='CS' and userid = '#getagent.userid#' and (void = '' or void is null)
			...
			<Row ss:AutoFitHeight="0" ss:Height="12">
				<Cell ss:StyleID="s36"/>
				<Cell ss:Index="3" ss:StyleID="s37"><Data ss:Type="Number">#subsales#</Data></Cell>
	...
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfloop query="getagent">
				...
				<td><font size="2" face="Times New Roman, Times, serif"><strong><u>#getagent.userid#</u></strong></font></td>
				...
				<td><font size="2" face="Times New Roman, Times, serif"><strong><u>#getusername.username#</u></strong></font></td>
