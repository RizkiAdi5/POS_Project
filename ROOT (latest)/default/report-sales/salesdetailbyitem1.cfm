...
<cfswitch expression="#form.result#">
	...
	<Worksheet ss:Name="SALES REPORT DETAIL BY ITEM">
	<cfoutput>
	...
	<cfset totalqty = 0>
		...
		<cfquery name="getitem" datasource="#dts#">
				...
				and itemno='#getgroup.itemno#' and (void = '' or void is null) and refno='#getgroup.refno#'
			</cfquery>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<cfset subamt = 0>
			<tr>
					...
					<td><font size="2" face="Times New Roman, Times, serif"><strong><u>#getgroup.desp#</u></strong></font></td>
			</tr>
			<cfquery name="getitem" datasource="#dts#">
				select * from ictran
				where (type = 'INV' or type = 'CS') 
            ...
            <cfset getitem.price=getitem.amt/getitem.qty>
				...
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<td><font size="2" face="Times New Roman, Times, serif"><a href='l_purchasereportCUST.cfm?custno=#urlencodedformat(getitem.custno)#'>#getitem.name#</a></font></td>
