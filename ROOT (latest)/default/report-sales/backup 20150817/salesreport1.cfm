...
<cfswitch expression="#form.result#">
	<cfcase value="HTML">
		<html>
		<head>
		<title>Top Sales Report - By Area</title>
		<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		<link href="../../../JRun4/servers/cfusion/cfusion-ear/cfusion-war/IMS/stylesheet/reportprint.css" rel="stylesheet" type="text/css">
		...
		<cfoutput>
		  <table width="100%" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
              ...
              <td><div align="right"><font size="2" face="Times New Roman, Times, serif">Commision</font></div></td>
            </tr>
            <tr>
              <td colspan="9"><hr></td>
            </tr>
            <cfquery name="getareadata" datasource="#dts#">
				select a.area,a.desp,b.suminvamt,c.sumcsamt,d.sumdnamt,e.sumcnamt,(ifnull(b.suminvamt,0)+ifnull(c.sumcsamt,0)+ifnull(d.sumdnamt,0)) as total,
				(ifnull(b.suminvamt,0)+ifnull(c.sumcsamt,0)+ifnull(d.sumdnamt,0)-ifnull(e.sumcnamt,0)) as net from icarea as a
				left join
				(select area,sum(net)as suminvamt from artran where type = 'INV' and (void = '' or void is null)
				<cfif form.areafrom neq "" and form.areato neq "">
				...
				group by area) as b on a.area=b.area

				left join
				(select area,sum(net)as sumcsamt from artran where type = 'CS' and (void = '' or void is null)
				<cfif form.areafrom neq "" and form.areato neq "">
					and area >='#form.areafrom#' and area <='#form.areato#'
				</cfif>
				<cfif trim(form.custfrom) neq "" and trim(form.custto) neq "">
				...
				group by area) as c on a.area=c.area

				left join
				(select area,sum(net)as sumdnamt from artran where type = 'DN' and (void = '' or void is null)
				<cfif form.areafrom neq "" and form.areato neq "">
					and area >='#form.areafrom#' and area <='#form.areato#'
				</cfif>
				<cfif trim(form.custfrom) neq "" and trim(form.custto) neq "">
				...
				group by area) as d on a.area=d.area

				left join
				(select area,sum(net)as sumcnamt from artran where type = 'CN' and (void = '' or void is null)
				<cfif form.areafrom neq "" and form.areato neq "">
					and area >='#form.areafrom#' and area <='#form.areato#'
				</cfif>
				<cfif trim(form.custfrom) neq "" and trim(form.custto) neq "">
				...
				group by area) as e on a.area=e.area

				<cfif form.areafrom neq "" and form.areato neq "">
					where a.area >='#form.areafrom#' and a.area <= '#form.areato#'
				</cfif>
				group by a.area order by net desc
            ...
            <cfset totalamt = 0>
            <cfset netamt = 0>
            <cfloop query="getareadata">
              <cfset totalinv = totalinv + val(getareadata.suminvamt)>
              <cfset totalcs = totalcs + val(getareadata.sumcsamt)>
              <cfset totaldn = totaldn + val(getareadata.sumdnamt)>
              <cfset totalcn = totalcn + val(getareadata.sumcnamt)>
              <cfset totalamt = totalamt + val(getareadata.total)>
              <cfset netamt = netamt + val(getareadata.net)>
              <cfset commision = val(getareadata.total) * val(getagent.commsion1)>
              <cfset netcommision = netamt * val(getagent.commsion1)>
              <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                <cfif getareadata.area eq "">
                  <td><font size="2" face="Times New Roman, Times, serif">No - Area</font></td>
                  <td><font size="2" face="Times New Roman, Times, serif">No - Area</font></td>
                  <cfelse>
                  <td><font size="2" face="Times New Roman, Times, serif">#getareadata.area#</font></td>
                  <td><font size="2" face="Times New Roman, Times, serif">#getareadata.desp#</font></td>
                </cfif>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getareadata.suminvamt),stDecl_UPrice)#</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getareadata.sumdnamt),stDecl_UPrice)#</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getareadata.sumcsamt),stDecl_UPrice)#</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getareadata.total),stDecl_UPrice)#</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(commision,",.__")#</font></div></td>
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getareadata.net),stDecl_UPrice)#</font></div></td>
              </tr>
            </cfloop>
            <tr>
              <td colspan="9"><hr></td>
		  ...
		  <cfif getareadata.recordcount eq 0>
	...
	<cfcase value="EXCELDEFAULT">
		...
		<Worksheet ss:Name="Top_Sales_Report - By Area">
		...
		<Row ss:AutoFitHeight="0" ss:Height="23.0625">
    		<Cell ss:MergeAcross="6" ss:StyleID="s31"><Data ss:Type="String">Top Sales Report - By Area</Data></Cell>
   		</Row>
		<cfoutput>
   		<cfif form.periodfrom neq "" and form.periodto neq "">
		...
		<cfloop query="getareadata">
			...
			<Row ss:Height="12">
				<cfif getareadata.area eq "">
					<Cell ss:StyleID="s27"><Data ss:Type="String">No - Area</Data></Cell>
					<Cell ss:StyleID="s27"><Data ss:Type="String">No - Area</Data></Cell>
				<cfelse>
					<cfwddx action = "cfml2wddx" input = "#getareadata.area#" output = "wddxText">
					<Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText#</Data></Cell>
					<cfwddx action = "cfml2wddx" input = "#getareadata.desp#" output = "wddxText">
					<Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText#</Data></Cell>
				</cfif>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getareadata.suminvamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getareadata.sumdnamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getareadata.sumcsamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getareadata.sumcnamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getareadata.net)#</Data></Cell>
			</Row>
			</cfloop>
			<Row ss:Height="12">
				<Cell ss:StyleID="s28"/>
