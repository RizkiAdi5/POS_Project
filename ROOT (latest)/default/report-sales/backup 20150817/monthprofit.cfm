...
<cfquery name="getteam" datasource="#dts#">
	...
	<form name="saleslist" action="monthprofit1.cfm?alown=#alown#" method="post" target="_blank">
...
<table width="70%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
    ...
    <tr> 
        <td colspan="2"><input type="checkbox" name="fixcost" id="fixcost" value="1"> Fix Cost</td>
    </tr>                
