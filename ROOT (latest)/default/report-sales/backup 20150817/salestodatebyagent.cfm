...
<html>
<head>
<title>Sales To Date By Sales Person Report</title>
...
<h3>
	...
	<a><font size="2">Print Sales To Date By Sales Person</font></a></h3>
...
<cfquery name="getlocation" datasource="#dts#">
	...
	<form name="saleslist" action="salestodatebyagent2.cfm?alown=#alown#" method="post" target="_blank">
