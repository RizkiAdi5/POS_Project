...
<h3>
	...
	<a><font size="2">Print Daily Profit Report</font></a></h3>
...
<cfquery name="getteam" datasource="#dts#">
	...
	<form name="saleslist" action="dailyprofit1.cfm?alown=#alown#" method="post" target="_blank">
	...
	<cfquery name="getagent" datasource="#dts#">
		...
		<cfif alown eq 1>
			<cfif getgeneral.agentlistuserid eq "Y">
				and ucase(agent) in (SELECT agent FROM icagent WHERE agentlist like "%#ucase(huserid)#%")
			<cfelse>
...
<table width="70%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	...
	<tr>
		...
		<td>
			...
			<input type="checkbox" name="fixcost" id="fixcost" value="1"> Fix Cost
		</td>
	</tr>
    <tr> 
        <td colspan="4"><hr></td>
    ...
    <tr>
    <td colspan="100%">
    <input type="checkbox" name="excludevisa" id="excludevisa" value="1">Exclude Visa<br>
    <input type="checkbox" name="excludenett" id="excludenett" value="1">Exclude Nett
    </td>
    </tr>
    </cfif>
