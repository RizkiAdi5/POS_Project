...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,agentlistuserid,lTEAM from gsetup
</cfquery>
<!--- Add On 15-01-2010 --->
...
<table width="75%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	...
	<tr>
		...
		<td nowrap>
            ...
            <br>
            <input type="radio" name="focqty" id="2" value="yes"> Show FOC Qty</br>
		</td>
	</tr>
	<tr>
...
<form name="salestype" action="salestype4.cfm?trantype=#trantype#" method="post" target="_blank">
<table width="60%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	<tr>
		<th>Report Format<input type="hidden" name="tran" id="tran" value="#target_arcust#" /><input type="hidden" name="fromto" id="fromto" value="" /></th>
		<td nowrap>
...
<form name="salestype" action="salestype6.cfm?trantype=#trantype#" method="post" target="_blank">
<table width="60%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	<tr>
		<th>Report Format<input type="hidden" name="tran" id="tran" value="#target_arcust#" /><input type="hidden" name="fromto" id="fromto" value="" /></th>
		<td nowrap>
