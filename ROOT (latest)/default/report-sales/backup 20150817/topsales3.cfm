...
<cfswitch expression="#form.result#">
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="9"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>TOP SALES REPORT BY #trantype#</strong></font></div></td>
			</tr>
			...
			<cfloop query="getareadata">
				...
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getareadata.sumcnamt),stDecl_UPrice)#</font></div></td>
