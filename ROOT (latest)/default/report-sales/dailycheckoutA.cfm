...
<cfset pageTitle = "Daily Checkout Report 2">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="saleslist" id="saleslist" action="dailycheckout2.cfm?alown=#alown#" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
				<tr> 
