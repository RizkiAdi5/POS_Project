...
<cfset pageTitle = "Daily Cash Sales Report By Cashier">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="saleslist" id="saleslist" action="cashsalesbycashier2.cfm?alown=#alown#" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table>
                <tr>
				...
				<tr>
        			...
        			<td><select name="cashierid" id="cashierid">
