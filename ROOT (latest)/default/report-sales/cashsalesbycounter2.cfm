...
<cfswitch expression="#form.result#">
	<cfcase value="EXCELDEFAULT">
		...
		<Styles>
	 	...
	 	<Worksheet ss:Name="Cash_Sales_Report_By_counter">
	 	<cfoutput>
		...
		<Row ss:AutoFitHeight="0" ss:Height="23.0625">
			<Cell ss:MergeAcross="8" ss:StyleID="s22"><Data ss:Type="String">Cash Sales Report By Counter</Data></Cell>
		</Row>
	   <cfif form.periodfrom neq "" and form.periodto neq "">
		...
		<Row ss:AutoFitHeight="0" ss:Height="23.0625">
			<Cell ss:StyleID="s27"><Data ss:Type="String">Counter.</Data></Cell>
		...
		<cfquery name="getagent" datasource="#dts#">
			select wos_date,refno,counter,sum(invgross) as invgross,sum(discount) as discount,sum(tax) as tax,sum(grand) as grand,sum(CS_PM_cash) as CS_PM_cash,sum(CS_PM_crcd) as CS_PM_crcd,sum(CS_PM_crc2) as CS_PM_crc2,sum(CS_PM_cheq) as  CS_PM_cheq,sum(CS_PM_vouc) as CS_PM_vouc, sum(deposit) as deposit,sum(CS_PM_dbcd) as CS_PM_dbcd,sum(CS_PM_cashcd) as CS_PM_cashcd from artran
		...
		<cfloop query="getagent">
				...
				<Row ss:AutoFitHeight="0">
					...
					<Cell ss:StyleID="s30"><Data ss:Type="String">#getagent.counter#</Data></Cell>
					<Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getagent.invgross)#</Data></Cell>
					<Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getagent.discount)#</Data></Cell>
					<Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getagent.tax)#</Data></Cell>
                    ...
                    <Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getagent.deposit)#</Data></Cell>
								...
								<cfset totalsales = totalsales + val(getagent.invgross)>
	...
	<cfcase value="HTML">
		<html>
		<head>
		<title>Cash Sales Report By Counter</title>
		...
		<cfquery name="getagent" datasource="#dts#">
			select wos_date,refno,counter,sum(invgross) as invgross,sum(discount) as discount,sum(tax) as tax,sum(grand) as grand,sum(CS_PM_cash) as CS_PM_cash,sum(CS_PM_crcd) as CS_PM_crcd,sum(CS_PM_crc2) as CS_PM_crc2,sum(CS_PM_cheq) as  CS_PM_cheq,sum(CS_PM_vouc) as CS_PM_vouc,sum(CS_PM_dbcd) as CS_PM_dbcd,sum(CS_PM_cashcd) as CS_PM_cashcd, sum(deposit) as deposit from artran
			where type='CS' and (void = '' or void is null)
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Cash Sales Report By Counter</strong></font></div></td>
			</tr>
            <tr>
            ...
            <cfset totalcashcd = 0>
				...
				<cfloop query="getagent">
					<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
						...
						<td><div align="left"><font size="2" face="Times New Roman, Times, serif">#getagent.counter#</font></div></td>
								<td><div align="right">#numberformat(val(getagent.invgross),',_.__')#</div></td>
