...
<body>
<cfoutput>
<!--- <h2>Print Cash Sales Report</h2> --->
<h3>
	<a href="salesmenu.cfm">Sales Report Menu</a> >> 
	<a><font size="2">Print Cash Sales Report</font></a></h3>
...
<cfquery name="getteam" datasource="#dts#">
	...
	<form name="saleslist" action="cashsalesreport1.cfm?alown=#alown#" method="post" target="_blank">
