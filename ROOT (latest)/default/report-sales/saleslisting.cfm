...
<cfswitch expression="#url.type#">
	...
	<cfcase value="agentlist">
		<cfset trantype = "AGENT SALES LISTING">
	</cfcase>
	<cfcase value="arealist">
...
<cfif type eq "customerlist">
	...
	<form name="saleslist" action="saleslisting1.cfm?trantype=#trantype#&alown=#alown#" method="post" target="_blank">
<cfelseif type eq "productlist">
	...
	<form name="saleslist" action="saleslisting2.cfm?trantype=#trantype#&alown=#alown#" method="post" target="_blank">
<cfelseif type eq "agentlist">
	...
	<form name="saleslist" action="saleslisting3.cfm?trantype=#trantype#&alown=#alown#" method="post" target="_blank">
<cfelseif type eq "arealist">
	...
	<form name="saleslist" action="saleslisting4.cfm?trantype=#trantype#&alown=#alown#" method="post" target="_blank">
</cfif>
...
<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='to';ColdFusion.Window.show('findCustomer');" />&nbsp;<input type="text" name="searchsuppto" onKeyUp="getCust('custto','Customer');">
    ...
    <tr>   
        ...
        <td><select name="itemfrom">
				...
				<option value="#convertquote(itemno)#">#itemno#</option>
				</cfloop>
			</select>
            <cfif getgeneral.filterall eq "1">
