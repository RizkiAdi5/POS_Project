...
<script type="text/javascript">
	...
	function default1()
	{
		...
		document.getElementById('bill_QUO').checked=false;
		...
		document.getElementById('bill_rem45').checked=false;
		document.getElementById('bill_rem46').checked=false;
		document.getElementById('bill_b_attn').checked=false;
		document.getElementById('bill_d_attn').checked=false;
		document.getElementById('bill_D_add').checked=false;
		...
		document.getElementById('billbody_pono').checked=false;
		...
		document.getElementById('simple_brem2').checked=false;
...
<cfquery datasource="#dts#" name="SaveGeneralInfo">
        ...
        <cfif isdefined("form.bill_rem45")>
        	,bill_rem45 = 'Y'
        <cfelse>
         	,bill_rem45 = 'N'
		</cfif>
        
        <cfif isdefined("form.bill_rem46")>
        	,bill_rem46 = 'Y'
        <cfelse>
         	,bill_rem46 = 'N'
		</cfif>
        ...
        <cfif isdefined("form.bill_d_add")>
        	,bill_d_add = 'Y'
        <cfelse>
         	,bill_d_add = 'N'
		</cfif>
        ...
        <cfif isdefined("form.billbody_pono")>
        	,billbody_pono = 'Y'
        <cfelse>
         	,billbody_pono = 'N'
		</cfif>
        ...
        <cfif isdefined("form.simple_brem2")>
        	,simple_brem2 = 'Y'
        <cfelse>
         	,simple_brem2 = 'N'
		</cfif>
...
<cfform name="displaysetup" action="displaysetup.cfm?done=1" method="post">
    ...
    <tr><th colspan="2"><div align="center">Bill Header Listing</div></th></tr>
		<tr>
          ...
          <tr>
            <th>QUO</th>
            <td><input name="bill_QUO" type="checkbox" value="Y" <cfif getdisplaysetup.bill_QUO eq 'Y'>checked</cfif>></td>
          </tr>
          <tr>
          ...
          <tr>
            <th>Remark 45</th>
            <td><input name="bill_rem45" id="bill_rem45" type="checkbox" value="Y" <cfif getdisplaysetup.bill_rem45 eq 'Y'>checked</cfif>></td>
          </tr>
          <tr>
            <th>Remark 46</th>
            <td><input name="bill_rem46" id="bill_rem46" type="checkbox" value="Y" <cfif getdisplaysetup.bill_rem46 eq 'Y'>checked</cfif>></td>
          </tr>
          <tr>
            <th>B_Attn</th>
          ...
          <tr>
            ...
            <td><input name="bill_d_add" id="bill_d_add" type="checkbox" value="Y" <cfif getdisplaysetup.bill_d_add eq 'Y'>checked</cfif>></td>
          </tr>
          <tr>
            <th>Billing Phone</th>
        ...
        <tr>
          ...
          <tr>
            <th>Po No.</th>
            <td><input name="billbody_pono" type="checkbox" value="Y" <cfif getdisplaysetup.billbody_pono eq 'Y'>checked</cfif>></td>
          </tr>
		...
		<tr>
         ...
         <tr>
          ...
          <tr>
            <th>Brem 2</th>
            <td><input name="simple_brem2" type="checkbox" value="Y" <cfif getdisplaysetup.simple_brem2 eq 'Y'>checked</cfif>></td>
          </tr>
