<cfset pageTitle="Identifier Profile">
<cfset targetTitle="Identifier">
<cfset targetTable="identifier">
<cfset displayEditDelete=getUserPin2.H10319g_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/identifierProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10319g_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/identifier.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10319g_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/identifierProcess.cfm?action=print','_blank');">
