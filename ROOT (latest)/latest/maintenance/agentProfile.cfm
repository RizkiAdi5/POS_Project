...
<cfset words_id_list = "513,29,65,10,11,514,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[513]#">
<cfset targetTitle="Agent">
<cfset targetTable=target_icagent>
<cfset displayEditDelete=getUserPin2.H10314_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/agentProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10314_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/agent.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[514]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10314_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/agentProcess.cfm?action=print','_blank');">
