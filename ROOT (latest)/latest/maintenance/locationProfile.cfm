...
<cfset words_id_list = "480,482,65,10,11,481,3">
...
<cfset pageTitle="#words[480]#">
<cfset targetTitle="Location">
<cfset targetTable="iclocation">
<cfset displayEditDelete=getUserPin2.H10319b_3b>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var locationProfile='#words[482]#';
        var description='#words[65]#';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/locationProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10319b_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/location.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[481]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10319b_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/locationProcess.cfm?action=print','_blank');">
