<cfset pageTitle="Enquiry Opening Value">
<cfset targetTitle="Enquiry Opening Value">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/enquiryOpeningValue.js"></script>
