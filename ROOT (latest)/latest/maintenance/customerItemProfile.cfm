...
<cfset targetTitle="Customer/Item Price">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var targetTable='#target_arcust#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/customerItemProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/customerItemPrice.cfm?action=create','_self');">
                    <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                </button>
                <!---
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/customerItemProcess.cfm?action=print','_blank');">
