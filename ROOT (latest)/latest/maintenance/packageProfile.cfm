<cfset pageTitle="Package Profile">
<cfset targetTitle="Package">
<cfset targetTable="package">
<cfset displayEditDelete="">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/PackageProfile.js"></script>
		...
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10201_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/package.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10201_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/packageProcess.cfm?action=print','_blank');">
