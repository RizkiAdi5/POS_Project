...
<cfset words_id_list = "529,530,65,10,11,531,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[529]#">
<cfset targetTitle="Term">
<cfset targetTable=target_icterm>
<cfset displayEditDelete=getUserPin2.H10319e_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/termProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10319e_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/term.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[531]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10319e_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/termProcess.cfm?action=print','_blank');">
