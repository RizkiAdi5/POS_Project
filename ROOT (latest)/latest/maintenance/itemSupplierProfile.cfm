<cfset pageTitle="Item/Supplier Price ">
<cfset targetTitle="Item/Supplier Price">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/itemSupplierProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/itemSupplierPrice.cfm?action=create','_self');">
                    <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                </button>
                
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/itemSupplierPriceProcess.cfm?action=print','_blank');">
