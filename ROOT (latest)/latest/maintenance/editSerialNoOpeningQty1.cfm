...
<cfset pageTitle="Edit Serial No Opening Quantity">
<cfset targetTitle="Edit Serial No Opening Quantity">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript">
        var dts='#dts#';
		var itemno = '#URLitemno#';
        var targetTitle='#targetTitle#';
        var targetTable='#targetTable#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/editSerialNoOpeningQty1.js"></script>
...
<div class="container">
	<div class="page-header">
		<h2>
			...
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/addSerialNo.cfm?action=create&itemno=#URLitemno#','_self');">
				<span class="glyphicon glyphicon-plus"></span> Add Serial No
			</button>
			</div>
		</h2>
	</div>
