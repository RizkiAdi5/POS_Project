<cfset pageTitle="Matrix Profile">
<cfset targetTitle="Matrix">
<cfset targetTable="icmitem">
<cfset displayEditDelete=getUserPin2.H10418_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/matrixProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10418_3a EQ 'T'>
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/matrix.cfm?action=create','_self');">
				<span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
			</button>
                </cfif>
                <cfif getUserPin2.H10418_3c EQ 'T'>
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/matrixProcess.cfm?action=print','_blank');">
