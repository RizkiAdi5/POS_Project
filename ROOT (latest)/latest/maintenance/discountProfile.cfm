...
<cfset words_id_list = "590,592,65,10,11,591,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[590]#">
<cfset targetTitle="Discount">
<cfset targetTable="discount">
<cfset displayEditDelete=getUserPin2.H10416_3b>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var discount='#words[592]#';
        var description='#words[65]#';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/discountProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10416_3a EQ 'T'>
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/discount.cfm?action=create','_self');">
				<span class="glyphicon glyphicon-plus"></span> #words[591]#
			</button>
                </cfif>
                <cfif getUserPin2.H10416_3c EQ 'T'>
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/discountProcess.cfm?action=print','_blank');">
