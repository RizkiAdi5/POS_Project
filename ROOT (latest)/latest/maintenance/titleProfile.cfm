...
<cfset pageTitle="#userDefined# Profile">
<cfset targetTitle="#userDefined#">
<cfset targetTable="title">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/titleProfile.js"></script>
...
<div class="container">
	<div class="page-header">
		<h2>
			...
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/title.cfm?action=create','_self');">
				<span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
			</button>
            
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/titleProcess.cfm?action=print','_blank');">
