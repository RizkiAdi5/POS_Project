<cfset pageTitle="Collect Address Profile">
<cfset targetTitle="Collection Address">
<cfset targetTable="collect_address">
<cfset displayEditDelete=getUserPin2.H10313_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/collectAddressProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10313_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/collectAddress.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10313_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/collectAddressProcess.cfm?action=print','_blank');">
