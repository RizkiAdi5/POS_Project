<cfset pageTitle="Area Profile">
<cfset targetTitle="Area">
<cfset targetTable=target_icarea>
<cfset displayEditDelete=getUserPin2.H10316_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/areaProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10316_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/area.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10316_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/areaProcess.cfm?action=print','_blank');">
