...
<cfset targetTitle="Service">
<cfset targetTable="icservi">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/serviceProfile.js"></script>
		...
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10104_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/service.cfm?action=create&menuID=#url.menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10104_3c EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/serviceProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
