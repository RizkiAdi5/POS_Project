<cfcomponent>
    <cffunction name="listAccount" access="remote" returntype="struct">
        ...
        <cfquery name="listMatchedAccount" datasource="#dts#">
            ...
            FROM business
            WHERE business LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#term#%" />
        ...
        <cfloop query="listMatchedAccount">
            ...
            <cfset matchedAccount["id"]=evaluate('listMatchedAccount.business')>
            <cfset matchedAccount["business"]=evaluate('listMatchedAccount.business')>
    ...
    <cffunction name="getSelectedAccount" access="remote" returntype="struct">
        ...
        <cfquery name="getSelectedAccount" datasource="#dts#">
            SELECT business,desp
            FROM business
            WHERE business=<cfqueryparam cfsqltype="cf_sql_varchar" value="#value#" />;
        </cfquery>
        
        <cfset selectedAccount=StructNew()>
        <cfset matchedAccount["id"]=evaluate('listMatchedAccount.business')>
        <cfset selectedAccount["business"]=evaluate('getSelectedAccount.business')>
