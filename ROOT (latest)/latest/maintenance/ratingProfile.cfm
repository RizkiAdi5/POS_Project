...
<cfset words_id_list = "393,152,65,10,11,394,3">
<cfinclude template="/latest/words.cfm">
<cfinclude template="/latest/pageTitle/pageTitle.cfm">
<cfset targetTitle="Rating">
<cfset targetTable="iccostcode">
<cfset pageTitle = "#words[393]#">
<cfset displayEditDelete=getUserPin2.H10204_3b>
...
<head>
    ...
    <script type="text/javascript">
		...
		var rating='#words[152]#';
		var description='#words[65]#';
		var action='#words[10]#';
		var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/ratingProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10204_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/rating.cfm?action=create&menuID=#url.menuID#','_self');">
                        <span class="glyphicon glyphicon-plus"></span> #words[394]#
                    </button>
                </cfif>
                <cfif getUserPin2.H10204_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/ratingProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
