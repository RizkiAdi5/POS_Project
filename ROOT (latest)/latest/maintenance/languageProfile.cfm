<cfset pageTitle="Language Profile">
<cfset targetTitle="Language">
<cfset targetTable="iclanguage">
<cfset displayEditDelete=getUserPin2.H10417_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/languageProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10417_3a EQ 'T'>
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/language.cfm?action=create','_self');">
				<span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
			</button>
                </cfif>
                <cfif getUserPin2.H10417_3c EQ 'T'>
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/languageProcess.cfm?action=print','_blank');">
