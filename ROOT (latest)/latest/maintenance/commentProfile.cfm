<cfset pageTitle="Comment Profile">
<cfset targetTitle="Comment">
<cfset targetTable="comments">
<cfset displayEditDelete=getUserPin2.H10319_3b>
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/commentProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10319_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/comment.cfm?action=create','_self');">
                        <span class="glyphicon glyphicon-plus"></span> Add #targetTitle#
                    </button>
                </cfif>
                <cfif getUserPin2.H10319_3a EQ 'T'>
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/commentProcess.cfm?action=print','_blank');">
