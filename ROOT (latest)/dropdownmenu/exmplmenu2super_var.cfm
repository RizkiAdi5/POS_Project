...
document.write('</style>');
	...
	<cfif getpin2.h1000 eq "T">
		...
		<cfset counter_m = counter_m + 1><!---Bill Header Item--->
		
			<cfif getpin2.h1K00 eq "T">		<!--- Opening Qty Maintenance --->
			<cfset counter_m = counter_m + 1>
		</cfif>
		
		<cfset counter_m = counter_m + 1><!--- MISC Item Maintenance --->
...
<!--- <cfif getpin2.h1M10 eq "T">	<!--- Edit Item Opening Quantity/Cost --->
	...
	<!---  	</cfif>--->
		...
		Menu<cfoutput>#menucount#_#menucount_m#</cfoutput>=new Array("<a>MISC</a>","","",0<cfoutput>#counter_m_o#</cfoutput>,hheight,wwidth+20,"","","","","","",-1,0,-1,"","");
			...
			<cfif getpin2.h1R00 eq "T">
				<cfset menucount_m_o = menucount_m_o + 1>
				Menu<cfoutput>#menucount#_#menucount_m#_#menucount_m_o#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/maintenance/promotion/' target='mainFrame'>Promotion</a>","","",0,hheight,wwidth+45,"","","","","","",-1,0,-1,"","");
			</cfif>
	...
	<cfif getpin2.h2000 eq "T">
		...
		<cfset counter_t = counter_t + 1><!--- Recurring Transaction --->
		</cfif>
		...
		<cfif getpin2.h2A00 eq "T">
			...
			<cfset menucount_t_g = menucount_t_g + 1>
			Menu<cfoutput>#menucount#_#menucount_t#_#menucount_t_g#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/transaction/recurringtran/' target='_blank'>E-Invoice Log</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			
		</cfif>
		
		<cfif getpin2.h2C00 eq "T">
				<cfset menucount_t = menucount_t + 1>
				Menu<cfoutput>#menucount#_#menucount_t#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/transaction/transaction.cfm?tran=dn' target='mainFrame'>Recurring Transaction</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			</cfif>
	...
	<cfif getpin2.h3000 eq "T">
		...
		<cfset counter_menu_e_oat = 0>
		<cfif getpin2.h3210 eq "T">
		<cfset counter_menu_e_oat = counter_menu_e_oat + 1>
		</cfif>
		...
		<cfif getpin2.h3200 eq "T">
			<cfset menucount_e = menucount_e + 1>
			Menu<cfoutput>#menucount#_#menucount_e#</cfoutput>=new Array("<a>Outstanding And Tracking</a>","","",<cfoutput>#counter_menu_e_oat#</cfoutput>,hheight,wwidth+45,"","","","","","",-1,0,-1,"","");		<cfset menu_e_oat = 0>
		<cfif getpin2.h3210 eq "T">
		<cfset menu_e_oat = menu_e_oat + 1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=DO' target='mainFrame'>Delivery Order</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h3220 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=QUO' target='mainFrame'>Quotation</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h3230 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=3' target='mainFrame'>Purchase Order</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h3240 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=4' target='mainFrame'>PO Details</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h3250 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=5' target='mainFrame'>Sales Order</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h3260 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=6' target='mainFrame'>SO Details</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h3270 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/outreport.cfm?type=7' target='mainFrame'>SO to PO</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h3290 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/updatedbill_form.cfm?frtype=SO&totype=INV' target='mainFrame'>SO To INV</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h32A0 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/updatedbill_form.cfm?frtype=SO&totype=PO' target='mainFrame'>SO To PO</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h32B0 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/updatedbill_form.cfm?frtype=QUO&totype=' target='mainFrame'>Quotation</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h32C0 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/updatedbill_form.cfm?frtype=PO&totype=RC' target='mainFrame'>PO To RC</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h32D0 eq "T">
		<cfset menu_e_oat = menu_e_oat+1>
			Menu<cfoutput>#menucount#_#menucount_e#_#menu_e_oat#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/enquires/updatedbill_form.cfm?frtype=DO&totype=INV' target='mainFrame'>DO To INV</a>","","",0,hheight,wwidth+25,"","","","","","",-1,0,-1,"","");
			</cfif>
	...
	<cfif getpin2.h4000 eq "T">
		...
		<cfset counter_menucount_r_s_count = 0>
		<cfif getpin2.h43I0 eq 'T'>
		<cfset counter_menucount_r_s_count = counter_menucount_r_s_count + 1 >
		</cfif>
		...
		<cfset counter_menucount_r_s_count = counter_menucount_r_s_count + 1 >
			...
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4=new Array("<a>Calculate Cost Of Sales</a>","","",<cfoutput>#counter_menucount_r_s_count#</cfoutput>,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		<cfset menucount_r_s_count = 0>
		<cfif getpin2.h43I0 eq 'T'>
		<cfset menucount_r_s_count = menucount_r_s_count + 1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4_<cfoutput>#menucount_r_s_count#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/calculatecostmenu.cfm?type=fixed' target='mainFrame'>Fixed Cost</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h43J0 eq 'T'>
		<cfset menucount_r_s_count = menucount_r_s_count + 1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4_<cfoutput>#menucount_r_s_count#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/calculatecostmenu.cfm?type=fifo' target='mainFrame'>First In First Out</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h43K0 eq 'T'>
		<cfset menucount_r_s_count = menucount_r_s_count + 1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4_<cfoutput>#menucount_r_s_count#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/calculatecostmenu.cfm?type=lifo' target='mainFrame'>Last In First Out</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h43L0 eq 'T'>
		<cfset menucount_r_s_count = menucount_r_s_count + 1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4_<cfoutput>#menucount_r_s_count#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/calculatecostmenu.cfm?type=month' target='mainFrame'>Month Average</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h43M0 eq 'T'>
		<cfset menucount_r_s_count = menucount_r_s_count + 1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4_<cfoutput>#menucount_r_s_count#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/calculatecostmenu.cfm?type=moving' target='mainFrame'>Moving Average</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		
			<cfset counter_r_s_profit = 0>		<!--- By Bill Item, By Customer --->
			...
			<cfif getpin2.h43N0 eq 'T'>		<!--- By Bill Item --->
				<cfset counter_r_s_profit = counter_r_s_profit + 1>
			</cfif>
			<cfif getpin2.h43O0 eq 'T'>		<!--- By Customer --->
				<cfset counter_r_s_profit = counter_r_s_profit + 1>
			</cfif>
		...
		<cfif getpin2.h43O0 eq 'T'>
			...
			<cfif getpin2.h43P0 eq 'T'>		<!--- By Area --->
				<cfset counter_r_s_listing = counter_r_s_listing + 1>
			</cfif>
			...
			<cfset counter_menucount_r_s_productsales= 0>
			<cfif getpin2.h43Q0 eq 'T'>	
			<cfset counter_menucount_r_s_productsales= counter_menucount_r_s_productsales+1>
			</cfif>
			<cfif getpin2.h43R0 eq 'T'>	
			<cfset counter_menucount_r_s_productsales= counter_menucount_r_s_productsales+1>
			</cfif>
			
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_7=new Array("<a>Top/Bottom Product Sales</a>","","",<cfoutput>#counter_menucount_r_s_productsales#</cfoutput>,hheight+10,wwidth,"","","","","","",-1,0,-1,"","");
			
			<cfset menucount_r_s_productsales= 0>
			
			
			<cfif getpin2.h43Q0 eq 'T'>	
			<cfset menucount_r_s_productsales= menucount_r_s_productsales+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_7_<cfoutput>#menucount_r_s_productsales#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/topbottomsales.cfm?type=top' target='mainFrame'>Top Product Sales</a>","","",0,hheight,wwidth+10,"","","","","","",-1,0,-1,"","");
			</cfif>
			<cfif getpin2.h43R0 eq 'T'>	
			<cfset menucount_r_s_productsales= menucount_r_s_productsales+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_7_<cfoutput>#menucount_r_s_productsales#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/topbottomsales.cfm?type=bottom' target='mainFrame'>Bottom Product Sales</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			</cfif>
			
			<cfset counter_menucount_r_s_topsales= 0>
			<cfif getpin2.h43S0 eq 'T'>	
			<cfset counter_menucount_r_s_topsales= counter_menucount_r_s_topsales+1>
			</cfif>
			...
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_8=new Array("<a>Top Sales Report</a>","","",<cfoutput>#counter_menucount_r_s_topsales#</cfoutput>,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			
			<cfset menucount_r_s_topsales= 0>
			<cfif getpin2.h43S0 eq 'T'>	
			<cfset menucount_r_s_topsales= menucount_r_s_topsales+1>
			Menu<cfoutput>#menucount#_#menucount_r#_8_#menucount_r_s_topsales#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/topsales.cfm?type=customertype' target='mainFrame'>Top Sales By Customers</a>","","",0,hheight,wwidth+30,"","","","","","",-1,0,-1,"","");
			</cfif>
			<cfif getpin2.h43T0 eq 'T'>	
			<cfset menucount_r_s_topsales= menucount_r_s_topsales+1>
			Menu<cfoutput>#menucount#_#menucount_r#_8_#menucount_r_s_topsales#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/topsales.cfm?type=agenttype' target='mainFrame'>Top Sales By Agent</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			</cfif>
			<cfif getpin2.h43U0 eq 'T'>	
			<cfset menucount_r_s_topsales= menucount_r_s_topsales+1>
		
			Menu<cfoutput>#menucount#_#menucount_r#_8_#menucount_r_s_topsales#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-sales/topsales.cfm?type=areatype' target='mainFrame'>Top Sales By Area</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			</cfif>
		</cfif>
		...
		<cfset counter_menucount_r_p_prbt= 0>
			<cfif getpin2.h4410 eq 'T'>	
			<cfset counter_menucount_r_p_prbt= counter_menucount_r_p_prbt+1>
			</cfif>
			<cfif getpin2.h4420 eq 'T'>	
			<cfset counter_menucount_r_p_prbt= counter_menucount_r_p_prbt+1>
			</cfif>
			
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_1=new Array("<a>Purchase Report By Type</a>","","",<cfoutput>#counter_menucount_r_p_prbt#</cfoutput>,hheight,wwidth+65,"","","","","","",-1,0,-1,"","");
			
			<cfset menucount_r_p_prbt= 0>
		<cfif getpin2.h4410 eq 'T'>	
		<cfset menucount_r_p_prbt= menucount_r_p_prbt+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_1_<cfoutput>#menucount_r_p_prbt#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchasetype.cfm?type=producttype' target='mainFrame'>Products Purchase</a>","","",0,hheight,wwidth+30,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h4420 eq 'T'>	
		<cfset menucount_r_p_prbt= menucount_r_p_prbt+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_1_<cfoutput>#menucount_r_p_prbt#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchasetype.cfm?type=vendortype' target='mainFrame'>Vendor Supply</a>","","",0,hheight,wwidth+30,"","","","","","",-1,0,-1,"","");
			</cfif>
		
		<cfset counter_menucount_r_p_prbm= 0>
			<cfif getpin2.h4430 eq 'T'>	
			<cfset counter_menucount_r_p_prbm= counter_menucount_r_p_prbm+1>
			</cfif>
			<cfif getpin2.h4440 eq 'T'>	
			<cfset counter_menucount_r_p_prbm= counter_menucount_r_p_prbm+1>
			</cfif>
			
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_2=new Array("<a>Purchase Report By Month</a>","","",<cfoutput>#counter_menucount_r_p_prbt#</cfoutput>,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		
		<cfset menucount_r_p_prbm= 0>
		<cfif getpin2.h4430 eq 'T'>	
		<cfset menucount_r_p_prbm= menucount_r_p_prbm+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_2_<cfoutput>#menucount_r_p_prbm#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchasemonth.cfm?type=productmonth' target='mainFrame'>Products Purchase</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h4440 eq 'T'>	
		<cfset menucount_r_p_prbm= menucount_r_p_prbm+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_2_<cfoutput>#menucount_r_p_prbm#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchasemonth.cfm?type=vendormonth' target='mainFrame'>Vendor Supply</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		
		<cfset counter_menucount_r_p_prbq= 0>
			<cfif getpin2.h4430 eq 'T'>	
			<cfset counter_menucount_r_p_prbq= counter_menucount_r_p_prbq+1>
			</cfif>
			<cfif getpin2.h4440 eq 'T'>	
			<cfset counter_menucount_r_p_prbq= counter_menucount_r_p_prbq+1>
			</cfif>
		
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_3=new Array("<a>Purchase Report By Quantity</a>","","",<cfoutput>#counter_menucount_r_p_prbq#</cfoutput>,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			
		<cfset menucount_r_p_prbq= 0>
		<cfif getpin2.h4450 eq 'T'>	
		<cfset menucount_r_p_prbq= menucount_r_p_prbq+1>
		
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_3_<cfoutput>#menucount_r_p_prbq#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchasequantity.cfm?type=vendorproduct' target='mainFrame'>Vendor - Products</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		<cfif getpin2.h4460 eq 'T'>	
		<cfset menucount_r_p_prbq= menucount_r_p_prbq+1>
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_3_<cfoutput>#menucount_r_p_prbq#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchasequantity.cfm?type=productvendor' target='mainFrame'>Products - Vendor</a>","","",0,hheight,wwidth,"","","","","","",-1,0,-1,"","");
		</cfif>
		
		<cfset counter_menucount_r_p_plr= 0>
			<cfif getpin2.h4470 eq 'T'>	
			<cfset counter_menucount_r_p_plr= counter_menucount_r_p_plr+1>
			</cfif>

			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4=new Array("<a>Purchase Listing Report</a>","","",<cfoutput>#counter_menucount_r_p_plr#</cfoutput>,hheight,wwidth,"","","","","","",-1,0,-1,"","");
			
			<cfset menucount_r_p_plr= 0>
		<cfif getpin2.h4470 eq 'T'>	
		<cfset menucount_r_p_plr= menucount_r_p_plr+1>
		
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>_4_<cfoutput>#menucount_r_p_plr#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-purchase/purchaselisting.cfm' target='mainFrame'>Purchase Listing By Vendors</a>","","",0,hheight+15,wwidth,"","","","","","",-1,0,-1,"","");
			</cfif>
		</cfif>
		...
		<cfif getpin2.h4D00 eq "T">		<!--- Service Report --->
			...
			<cfset counter_r_service = 0>
			<cfif getpin2.h4D10 eq "T">
				<cfset counter_r_service = counter_r_service + 1>
			</cfif>
			...
			Menu<cfoutput>#menucount#_#menucount_r#</cfoutput>=new Array("<a>Service Report</a>","","",<cfoutput>#counter_r_service#</cfoutput>,hheight,wwidth+70,"","","","","","",-1,0,-1,"","");
			
			<cfset menucount_r_service = 0>
			<cfif getpin2.h4D10 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform.cfm?type=listprojitem' target='mainFrame'>List By Service Item</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
			
			<cfif getpin2.h4D20 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform1.cfm?type=salesiss' target='mainFrame'>Service Income report</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
			
			<cfif getpin2.h4D30 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform2.cfm?type=salesiss' target='mainFrame'>Customer - ServiceReport</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
			
			<cfif getpin2.h4D40 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform3.cfm?type=projitemiss' target='mainFrame'>Agent - ServiceReport</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>

		<cfif getpin2.h4D50 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform4.cfm' target='mainFrame'>Supplier - ServiceReport</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>

		<cfif getpin2.h4D60 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform5.cfm' target='mainFrame'>Service Profit Margin - Transactions</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
		
		<cfif getpin2.h4D70 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicereportform6.cfm' target='mainFrame'>Service Profit Margin - Service Code</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
		
		<cfif getpin2.h4D80 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/servicemonth.cfm' target='mainFrame'>Service Part Report - By Month</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>

		<cfif getpin2.h4D90 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/productivitymonth.cfm' target='mainFrame'>Productivity Report - By Month</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
		<cfif getpin2.h4D90 eq "T">
				<cfset menucount_r_service = menucount_r_service + 1>
				Menu<cfoutput>#menucount#_#menucount_r#_#menucount_r_service#</cfoutput>=new Array("<a href='/<cfoutput>#HDir#</cfoutput>/report-service/p_servicereportproject.cfm' target='mainFrame'>Service Report - By Project</a>","","",0,hheight,wwidth+120,"","","","","","",-1,0,-1,"","");
			</cfif>
		</cfif>
	...
	<cfset menucount = menucount + 1>
	Menu<cfoutput>#menucount#</cfoutput>=new Array("<a href='/ext/docs/' target='mainFrame')>Help</a>","","../dropdownmenu/bgmenu.PNG",0,hhheight,wwidth-80,"","","","","","",-1,-1,-1,"","");
