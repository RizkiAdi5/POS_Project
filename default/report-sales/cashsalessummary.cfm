...
<cfset pageTitle = "Cash Sales Summary Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="saleslist" id="saleslist" action="cashsalessummary1.cfm?alown=#alown#" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
				<tr> 
