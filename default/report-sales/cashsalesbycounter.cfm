...
<cfset pageTitle = "Daily Cash Sales Report By Counter">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="saleslist" id="saleslist" action="cashsalesbycounter2.cfm?alown=#alown#" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
				<tr> 
