...
<cfset nametype = "cust">
    ...
    &nbsp;#UCASE(nametype)# NAME:&nbsp;<input type="text" name="custname1" id="custname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findCustomerAjax.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);" size="12" />
    
    &nbsp;#UCASE(nametype)# NO.</font>&nbsp;<input type="text" name="custno1" size="8" id="custno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findCustomerAjax.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);" <cfif isdefined('url.custno')>value="#url.custno#"</cfif>  />
    <br />
