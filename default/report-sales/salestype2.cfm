...
<cfswitch expression="#form.result#">
	<cfcase value="HTML">
		<html>
		<head>
		<title>Customer Sales By Type Report</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="11"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>#trantype# SALES BY TYPE REPORT</strong></font></div></td>
			</tr>
			...
			<cfif form.userfrom neq "" and form.userto neq "">
				<tr>
					<td colspan="11"><div align="center"><font size="2" face="Times New Roman, Times, serif">END USER: #form.userfrom# - #form.userto#</font></div></td>
				</tr>
			</cfif>
			<cfswitch expression="#form.qtysold#">
				<cfcase value="yes">
					...
					<cfquery name="getcustomername" datasource="#dts#">
						select a.custno,a.name,b.agenno,a.agent,(select desp from icagent where agent=a.agent) as agentdesp,b.sumqty
						from #target_arcust# <!--- (SELECT * FROM #target_arcust# <cfif form.agentfrom neq "" and form.agentto neq "">
						WHERE agent >='#form.agentfrom#' and agent <= '#form.agentto#'
						</cfif> ) --->as a
						left join
						(select custno,sum(qty)as sumqty,agenno,van from ictran where (type='INV' or type='CS' or type='DN') and (void = '' or void is null)
						<cfif trim(form.custfrom) neq "" and trim(form.custto) neq "">
				...
				<cfdefaultcase>
					...
					<cfquery name="getcustomername" datasource="#dts#">
						select a.custno,a.name,b.agenno,b.van,a.agent,(select desp from icagent where agent=a.agent) as agentdesp,b.sumqty,
				...
				and a.agent in(select agent from icagent where team >= '#form.teamfrom#' and team <= '#form.teamto#')
					...
					<cfloop query="getcustomername">
						...
						<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
							...
							<td><font size="2" face="Times New Roman, Times, serif">#getcustomername.custno#</font></td>
							<td><font size="2" face="Times New Roman, Times, serif">#getcustomername.name#</font></td>
							<td><div align="center"><font size="2" face="Times New Roman, Times, serif">#getcustomername.agenno#</font></div></td>
							<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getcustomername.sumqty),"0")#</font></div></td>
	...
	<cfcase value="EXCELDEFAULT">
		...
		<Worksheet ss:Name="Customer_Sales_Report_By-Type">
		...
		<Row ss:AutoFitHeight="0" ss:Height="23.0625">
    		<Cell ss:MergeAcross="7" ss:StyleID="s31"><Data ss:Type="String">Customer Sales Report - By Type</Data></Cell>
   		</Row>
		<cfoutput>
		<cfif form.periodfrom neq "" and form.periodto neq "">
