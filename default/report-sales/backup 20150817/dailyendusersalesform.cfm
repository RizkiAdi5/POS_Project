...
<html>
<head>
<title>Print Daily Driver Sales Report</title>
...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,lTEAM,lAGENT,lDriver from gsetup
</cfquery>
...
<body>
<cfoutput>
	<h2>Print Daily Driver Sales Report</h2>
	<form name="salesday" action="dailyendusersales.cfm" method="post" target="_blank">
