...
<h3>
	...
	<a><font size="2">Print Daily Sales Qty Report</font></a></h3>
...
<cfquery name="getlocation" datasource="#dts#">
	...
	<form name="saleslist" action="salesqtyreport2.cfm?alown=#alown#" method="post" target="_blank">
...
<input type="hidden" name="tran" id="tran" value="#target_arcust#" /><input type="hidden" name="fromto" id="fromto" value="" />
		...
		<td>
            ...
            <input type="checkbox" id="showallitem" name="showallitem" value="1"> Show All Item
            </td>
	</tr>
	<tr> 
        <td colspan="4"><hr></td>
   ...
   <tr> 
    ...
    <tr> 
    	<th>Date</th>
        <td><input type="text" name="datefrom" maxlength="10" value="#dateformat(now(),'DD/MM/YYYY')#" size="11"> (DD/MM/YYYY)</td>
    </tr>
