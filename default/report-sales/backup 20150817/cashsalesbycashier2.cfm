	...
	<cfcase value="EXCELDEFAULT">
	   ...
	   <cfif form.periodfrom neq "" and form.periodto neq "">
		...
		<cfquery name="getagent" datasource="#dts#">
			select wos_date,refno,cashier,counter,sum(invgross) as invgross,sum(discount) as discount,sum(tax) as tax,sum(grand) as grand,sum(CS_PM_cash) as CS_PM_cash,sum(CS_PM_crcd) as CS_PM_crcd,sum(CS_PM_crc2) as CS_PM_crc2,sum(CS_PM_cheq) as  CS_PM_cheq,sum(CS_PM_vouc) as CS_PM_vouc, sum(deposit) as deposit,sum(CS_PM_dbcd) as CS_PM_dbcd,sum(CS_PM_cashcd) as CS_PM_cashcd,sum(MC1_BIL) as MC1_BIL,cashier from artran
...
<cfquery name="getictran" datasource="#dts#">
           ...
           <cfif form.locfrom neq "" and form.locto neq "">
            ...
            and wos_date=#getagent.wos_date# and refno in (select refno from artran where cashier='#getagent.cashier#')
                </cfquery>
	...
	<cfcase value="HTML">
		...
		<cfquery name="getagent" datasource="#dts#">
			select wos_date,refno,cashier,counter,sum(invgross) as invgross,sum(discount) as discount,sum(tax) as tax,sum(grand) as grand,sum(CS_PM_cash) as CS_PM_cash,sum(CS_PM_crcd) as CS_PM_crcd,sum(CS_PM_crc2) as CS_PM_crc2,sum(CS_PM_cheq) as  CS_PM_cheq,sum(CS_PM_vouc) as CS_PM_vouc,sum(CS_PM_dbcd) as CS_PM_dbcd,sum(CS_PM_cashcd) as CS_PM_cashcd, sum(deposit) as deposit, sum(mc1_bil) as MC1_BIL from artran
			where type='CS' and (void = '' or void is null)
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
