...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="6" ss:StyleID="s22"><Data ss:Type="String">Sales REPORT DETAIL (BY REFNO) 2</Data></Cell>
	</Row>
	...
	<cfset totalqty = 0>
		...
		<cfloop query="getitem">
			...
			<Row ss:AutoFitHeight="0" ss:Height="12">
                ...
                <Cell ss:StyleID="s29"><Data ss:Type="Number">#getitem.dispec1*100#</Data></Cell>
                <cfif getitem.qty neq 0>
                <Cell ss:StyleID="s29"><Data ss:Type="Number">#(getitem.price*(1-(getitem.dispec1)))#</Data></Cell>
                <cfelse>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <cfif form.locfrom neq "" and form.locto neq "">
			<tr>
			  <td colspan="9"><div align="center"><font size="2" face="Times New Roman, Times, serif">Location: #form.locfrom# - #form.locto#</font></div></td>
			</tr>
		</cfif>
		<cfif isdefined("form.itemfrom") and trim(form.itemfrom) neq "" and trim(form.itemto) neq "">
			<tr>
        ...
        select * from iclocation where location ='#form.locfrom#'
        </cfquery>
        <cfquery name="getlocationto" datasource="#dts#">
        select * from iclocation where location ='#form.locto#'
        </cfquery>
        <cfif trim(form.locfrom) neq "" and trim(form.locto) neq "">
			<tr>
			  <td colspan="9"><div align="center"><font size="2" face="Times New Roman, Times, serif">LOCATION: #form.locfrom#-#getlocationfrom.desp# - #form.locto#-#getlocationto.desp#</font></div></td>
			</tr>
		</cfif>
		<tr>
           ...
           <cfquery name="gettaxincl" datasource="#dts#">
            ...
            <cfset getitem.price=0>
                ...
                <td><font size="2" face="Times New Roman, Times, serif"><a href='l_purchasereportITEM.cfm?itemno=#urlencodedformat(getitem.itemno)#'></font></a></td>
                    ...
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#getitem.dispec1*100#%</font></div></td>
                    <cfif getitem.qty neq 0>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(getitem.price*(1-(getitem.dispec1)),stDecl_UPrice)#</font></div></td>
                    <cfelse>
