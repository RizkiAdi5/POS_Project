...
<cfswitch expression="#form.result#">
	<cfcase value="HTML">
		<html>
		<head>
		<title>Group Sales By Type Report</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfquery name="getgroup" datasource="#dts#">
				select a.wos_group,b.desp,c.suminvamt,d.sumcsamt,e.sumdnamt,f.sumcnamt,(ifnull(c.suminvamt,0)+ifnull(d.sumcsamt,0)+ifnull(e.sumdnamt,0)) as total,
				(ifnull(c.suminvamt,0)+ifnull(d.sumcsamt,0)+ifnull(e.sumdnamt,0)-ifnull(f.sumcnamt,0)) as net from icitem as a
				left join
				(select wos_group,desp from icgroup) as b on a.wos_group=b.wos_group

				left join
				(select wos_group,sum(amt) as suminvamt from ictran where type='INV'
				<cfif form.areafrom neq "" and form.areato neq "">
				...
				group by wos_group) as c on a.wos_group=c.wos_group

				left join
				(select wos_group,sum(amt) as sumcsamt from ictran where type='CS'
				<cfif form.areafrom neq "" and form.areato neq "">
				and area >='#form.areafrom#' and area <= '#form.areato#'
				</cfif>
                <cfif form.userfrom neq "" and form.userto neq "">
				...
				group by wos_group) as d on a.wos_group=d.wos_group

				left join
				(select wos_group,sum(amt) as sumdnamt from ictran where type='DN'
				<cfif form.areafrom neq "" and form.areato neq "">
				and area >='#form.areafrom#' and area <= '#form.areato#'
				</cfif>
                <cfif form.userfrom neq "" and form.userto neq "">
				...
				group by wos_group) as e on a.wos_group=e.wos_group

				left join
				(select wos_group,sum(amt) as sumcnamt from ictran where type='CN'
				<cfif form.areafrom neq "" and form.areato neq "">
				and area >='#form.areafrom#' and area <= '#form.areato#'
				</cfif>
                <cfif form.userfrom neq "" and form.userto neq "">
				...
				group by wos_group) as f on a.wos_group=f.wos_group
			...
			<cfloop query="getgroup">
				<cfset totalinv = totalinv + val(getgroup.suminvamt)>
				<cfset totalcs = totalcs + val(getgroup.sumcsamt)>
				<cfset totaldn = totaldn + val(getgroup.sumdnamt)>
				<cfset totalcn = totalcn + val(getgroup.sumcnamt)>
				<cfset totalamt = totalamt + val(getgroup.total)>
				<cfset netamt = netamt + val(getgroup.net)>
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getgroup.suminvamt),stDecl_UPrice)#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getgroup.sumcsamt),stDecl_UPrice)#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getgroup.sumdnamt),stDecl_UPrice)#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getgroup.total),stDecl_UPrice)#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getgroup.sumcnamt),stDecl_UPrice)#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(getgroup.net),stDecl_UPrice)#</font></div></td>
				</tr>
			</cfloop>
			<tr>
				<td colspan="9"><hr></td>
	...
	<cfcase value="EXCELDEFAULT">
		...
		<cfloop query="getgroup">
			...
			<Row ss:Height="12">
				<cfif getgroup.wos_group eq "">
					<Cell ss:StyleID="s27"><Data ss:Type="String">No - Grouped</Data></Cell>
					<Cell ss:StyleID="s27"><Data ss:Type="String">No - Grouped</Data></Cell>
				<cfelse>
					...
					<cfwddx action = "cfml2wddx" input = "#getgroup.desp#" output = "wddxText">
					<Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText#</Data></Cell>
				</cfif>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getgroup.suminvamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getgroup.sumdnamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getgroup.sumcsamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getgroup.sumcnamt)#</Data></Cell>
				<Cell ss:StyleID="s30"><Data ss:Type="Number">#val(getgroup.net)#</Data></Cell>
			</Row>
		</cfloop>
		<Row ss:Height="12">
    		<Cell ss:StyleID="s28"/>
