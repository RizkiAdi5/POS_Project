...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="6" ss:StyleID="s22"><Data ss:Type="String">Sales REPORT DETAIL(BY REFNO)</Data></Cell>
	</Row>
	...
	<cfset totalqty = 0>
        ...
        <cfquery name="getagentdesp" datasource="#dts#">
                select desp from icagent where agent='#getgroup.agenno#'
                </cfquery>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="9"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Sales REPORT DETAIL (BY AGENT)</strong></font></div></td>
		</tr>
		<cfif isdefined("form.periodfrom") and form.periodfrom neq "" and form.periodto neq "">
			<tr>
		...
		<cfset subamt = 0>
            ...
            <cfelse>
				...
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                    ...
                    <td><font size="2" face="Times New Roman, Times, serif"><a href='l_purchasereportCUST.cfm?custno=#urlencodedformat(getitem.custno)#'>#getitem.custno# - #getitem.name#</font></a></td>
