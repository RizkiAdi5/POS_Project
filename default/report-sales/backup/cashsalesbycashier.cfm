...
<h3>
	...
	<a><font size="2">Print Daily Cash Sales Report By Cashier</font></a></h3>
...
<cfquery name="getteam" datasource="#dts#">
	...
	<form name="saleslist" action="cashsalesbycashier2.cfm?alown=#alown#" method="post" target="_blank">
