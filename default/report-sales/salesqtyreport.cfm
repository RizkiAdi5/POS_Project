...
<cfset pageTitle = "Daily Sales Qty Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="salesqtyForm" id="salesqtyForm" action="salesqtyreport2.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
				<tr> 
