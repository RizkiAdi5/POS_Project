...
<html>
<head>
<title>Sales Report Detail By Agent</title>
...
<h3>
	...
	<a><font size="2">Print Sales Report Detail by Agent</font></a>
</h3>


<form name="salestype" action="Salesdetailbyagent1.cfm" method="post" target="_blank">
<table width="60%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	<tr><input type="hidden" name="tran" id="tran" value="#target_arcust#" /><input type="hidden" name="fromto" id="fromto" value="" />
		...
		<td>
            ...
            <input type="checkbox" name="include" id="include" value="yes">Include DN/CN<br>
            <input type="checkbox" name="excludetax" id="excludetax" value="Y" <cfif lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "viva_i">checked</cfif>/>Exclude Tax for Tax Included Bill
		</td>
	</tr>
    ...
    <tr>
      	<th>Agent From</th>
      	<td colspan="2"><select name="agentfrom">
          		<option value="">Select a agent no</option>
    ...
    <tr>
      	<th>Agent To</th>
      	<td colspan="2"><select name="agentto">
          		<option value="">Select a agent no</option>
          		<cfloop query="getagent">
            		<option value="#agent#">#agent# - #desp#</option>
          		</cfloop>
...
<input type="text" name="searchcustto" onKeyUp="getcust('custto','Customer');">
    ...
    <tr> 
	    ...
	    <tr> 
	        <th><cfoutput>#getgeneral.ljob#</cfoutput> To</th>
