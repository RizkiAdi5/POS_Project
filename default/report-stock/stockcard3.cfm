...
<cfif thislastaccdate neq "">
	...
	<cfif lcase(hcomid) eq "redd_i" or lcase(hcomid) eq "idi_i" or lcase(hcomid) eq "ge_i">
		<cfquery name="getictran" datasource="#dts#">
            ...
            and refno not in (select toinv from ictran where itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#"> and toinv <> "" group by toinv)
			</cfif>
...
<cfoutput>
	...
	<tr>
  	...
  	<tr>
    	...
    	<td><font size="2" face="Times New Roman, Times, serif"><div align="right"><cfif getcost.ffc11 neq 0 and getcost.ffc11 neq ''>#lsnumberformat(getcost.ffc11,',_.____')#<cfelse><cfif getgeneral.cost eq "Month">#lsnumberformat(getcost2.avcost,',_.____')#<cfelseif getgeneral.cost eq "Moving">#lsnumberformat(getcost2.avcost2,',_.____')#<cfelse>#lsnumberformat(getcost2.ucost,',_.____')#</cfif></cfif></div></font></td>

        <cfif lcase(hcomid) neq "epsilon_i">
        <td></td>
        </cfif>
        <cfif lcase(hcomid) neq "epsilon_i">
    	<td><font size="2" face="Times New Roman, Times, serif"><div align="right"><cfif itembal neq '' and itembal neq 0><cfif getcost.ffc11 neq 0 and getcost.ffc11 neq ''>#lsnumberformat(getcost.ffc11*itembal,',_.__')#<cfelse><cfif getcost2.ucost neq ''>#lsnumberformat(getcost2.ucost*itembal,',_.__')#<cfelse>0.00</cfif></cfif></cfif></div></font></td></cfif>
        </cfif>
  	</tr>
