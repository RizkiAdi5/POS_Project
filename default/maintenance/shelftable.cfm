...
<cfif #getPersonnel.recordcount# neq 0>
  ...
  <cfform action="shelftable.cfm" method="post">
    <div align="right">Page 
      ...
      <cfif #start# neq 1>
        <cfoutput>|| <a href="shelftable.cfm?start=#prevFive#">Previous</a> 
          ||</cfoutput> 
      </cfif>
      <cfif #page# neq #noOfPage#>
        <cfoutput> <a href="shelftable.cfm?start=#evaluate(nextFive)#">Next</a> 
          ||</cfoutput> 
      </cfif>
    ...
    <cfoutput query="getPersonnel" startrow="#start#" maxrows="5"> 
      <cfset strNo = "getPersonnel.shelf">
      <table align="center" class="data" width="450px">
        ...
        <tr> 
          <td colspan="2"><div align="right"><a href="shelftable2.cfm?type=Delete&shelf=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0"> 
              Delete</a> <a href="shelftable2.cfm?type=Edit&shelf=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr></cfif>
      </table>
      <br>
      <hr>
