...
<cfif getrecordcount.recordcount neq 0>
	...
	<cfform action="svehicles_newest.cfm" method="post" target="_self">
		...
		<cfif start neq 1>
			|| <a target="_self" href="svehicles_newest.cfm?start=#prevTwenty#">Previous</a> ||
		</cfif>
		
		<cfif page neq noOfPage>
			<a target="_self" href="svehicles_newest.cfm?start=#nextTwenty#">Next</a> ||
		</cfif>
