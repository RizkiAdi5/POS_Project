...
<cfform name="CreateCustomer" id="CreateCustomer" method="post" action="/default/maintenance/shellvehicles/createCustomerAjaxProcess.cfm"> 
<cfif isdefined('url.id') and hcomid eq "asiasoft_i">
<cfoutput>
...
<tr>
<th width="200px"><div align="left">Customer No.</div></th>
<td>
...
<cfif lcase(hcomid) eq "ltm_i"><cfoutput>
<br />
...
<td><cfinput type="text" name="name2" id="name2" size="50"  tabindex="4" maxlength="40"></td>
    ...
    <cfinput type="text" name="attn" id="attn" size="50" onBlur="JavaScript: document.getElementById('Dattn').value=document.getElementById('attn').value" tabindex="9" maxlength="35" required="yes" message="-Attention is required"></td>
            ...
            <tr>
              <th align="left"><div align="left">Tel</div></th>
            ...
            <cfoutput>
              ...
              <td><cfinput type="text" name="contact" id="contact" size="20" required="yes" message="-Contact is required" /></td>
