...
<cfform name="CreateCustomer" id="CreateCustomer" method="post" action="/default/maintenance/shellvehicles/createmakeAjaxProcess.cfm"> 
<table width="1000px" style="font-size:-2">
<tr>
<th width="200px" align="left">Make No.</th>
<td>
<cfoutput>
<input type="text" size="30" name="makeno" value="" maxlength="30">
</cfoutput>
</td>
</tr>
            <tr>
