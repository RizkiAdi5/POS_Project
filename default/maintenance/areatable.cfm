<html>
<head>
	<title>Maintenance Area</title></title>
...
<cfoutput>
	...
	<cfif getpin2.h1D30 eq 'T'>|| <a href="s_areatable.cfm?type=icarea">Search For Area</a></cfif>
	</h4>
</cfoutput>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="areatable.cfm" method="post">
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			<cfset strNo = 'getPersonnel.area'>

			<table align="center" class="data" width="50%">
				<tr>
          			<th width="20%">Area</th>
          			<td>#getPersonnel.area#</td>
        		</tr>
        		<tr>
          			<th>Description</th>
				...
				<tr>
					...
					<a href="areatable2.cfm?type=Delete&area=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="areatable2.cfm?type=Edit&area=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
				</cfif>
     	 	</table>
			<br>
