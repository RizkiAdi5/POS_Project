...
<cfset ptype = url.type >
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="selectlist('#getcustsupp.xcustno#','Cust#url.fromto#');ColdFusion.Window.hide('findCustomer');" >SELECT</a></td>
    </tr>
    </cfloop>
