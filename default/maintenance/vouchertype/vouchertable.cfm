<html>
<head>
	<title>Maintenance Voucher Type</title></title>
...
<h1>View Voucher Type Informations</h1>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="vouchertable.cfm" method="post">
		...
		<cfif start neq 1>
			<cfoutput>|| <a href="vouchertable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
		</cfif>

		<cfif page neq noOfPage>
			<cfoutput> <a href="vouchertable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
		</cfif>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			<cfset strNo = 'getPersonnel.voucherid'>

			<table align="center" class="data" width="50%">
				<tr>
          			<th width="20%">Voucher Type</th>
          			<td>#getPersonnel.voucherid#</td>
        		</tr>
        		<tr>
          			<th>Description</th>
          			<td>#getPersonnel.voucherdesp#</td>
        		</tr>

				<tr>
          			<td colspan="2"><div align="right">
					<a href="vouchertable2.cfm?type=Delete&voucher=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="vouchertable2.cfm?type=Edit&voucher=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
