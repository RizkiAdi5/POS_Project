...
<body>
<h1>Recommended Price Selection Page - Supplier/Item</h1>
<cfoutput>
  	<h4>
...
<form action="sitemsupprice.cfm" method="post">
	<cfoutput>
	<h1>Search By :
	<select name="searchType">
		<option value="custno">Supplier No</option>
		<option value="xname">Supplier Name</option>
	</select>
...
<cfquery datasource='#dts#' name="type">
	Select a.*, b.name as xname, b.currcode,b.status from Icl3p a, #target_apvend# b where a.custno = b.custno group by a.custno order by a.custno
</cfquery>
		...
		<table align="center" class="data" width="65%" cellpadding="2" cellspacing="0">
			...
			<cfoutput query="exactResult">
				<tr>
					...
					<td><div align="center">
					<a href="../icitem/itemsupprice2.cfm?type=Delete&custno=#URLEncodedFormat(exactResult.custno)#&status=#exactResult.Status#">Delete</a>&nbsp;
					<a href="../icitem/itemsupprice3.cfm?type=Edit&custno=#URLEncodedFormat(exactResult.custno)#&status=#exactResult.Status#">Edit</a></div>
					</td>
				</tr>
			</cfoutput>
		</table>
		...
		<table align="center" class="data" width="65%" cellpadding="2" cellspacing="0">
			...
			<cfoutput query="similarResult">
				<tr>
					...
					<a href="../icitem/itemsupprice2.cfm?type=Delete&custno=#URLEncodedFormat(similarResult.custno)#&status=#similarResult.Status#">Delete</a>&nbsp;
					<a href="../icitem/itemsupprice3.cfm?type=Edit&custno=#URLEncodedFormat(similarResult.custno)#&status=#similarResult.Status#">Edit</a></div>
					</td>
				</tr>
			</cfoutput>
		</table>
		...
		<cfoutput query="type" maxrows="20">
			<tr>
				...
				<td align="center">#type.status#</td>
      			<td nowrap><div align="center">
				<a href="../icitem/itemsupprice2.cfm?type=Delete&custno=#URLEncodedFormat(type.custno)#&status=#type.status#">Delete</a>&nbsp;
            	<a href="../icitem/itemsupprice3.cfm?type=Edit&custno=#URLEncodedFormat(type.custno)#&status=#type.status#">Edit</a></div>
				</td>
			</tr>
