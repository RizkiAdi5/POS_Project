...
<cfif #getPersonnel.recordcount# neq 0>
  ...
  <cfform action="coloridtable.cfm" method="post">
    <div align="right">Page 
      ...
      <cfif #start# neq 1>
        <cfoutput>|| <a href="coloridtable.cfm?start=#prevFive#">Previous</a> 
          ||</cfoutput> 
      </cfif>
      <cfif #page# neq #noOfPage#>
        <cfoutput> <a href="coloridtable.cfm?start=#evaluate(nextFive)#">Next</a> 
          ||</cfoutput> 
      </cfif>
    ...
    <cfoutput query="getPersonnel" startrow="#start#" maxrows="5"> 
      <cfset strNo = "getPersonnel.colorid">
      <table align="center" class="data" width="450px">
        ...
        <tr> 
          ...
          <td>#getPersonnel.colorid#</td>
        </tr>
        <tr> 
          <th>Description</th>
          <td>#getPersonnel.desp#<br></td>
        </tr>
		<cfif getpin2.h1811 eq 'T'>
        <tr> 
          <td colspan="2"><div align="right"><a href="coloridtable2.cfm?type=Delete&colorid=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0"> 
              Delete</a> <a href="coloridtable2.cfm?type=Edit&colorid=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr>
		</cfif>
      </table>
      <br>
