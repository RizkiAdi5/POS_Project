<html>
<head>
<title>View Business</title></title>
...
<cfoutput>
<h1>View Business Informations</h1>
</cfoutput>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="businesstable.cfm" method="post">
	...
	<cfif start neq 1>
		<cfoutput>|| <a href="businesstable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
	</cfif>
	
	<cfif page neq noOfPage>
		<cfoutput> <a href="businesstable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
	</cfif>
	...
	<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
		<cfset strNo = "getPersonnel.business"> 
		<table align="center" class="data" width="450px">	
			<tr><th width="20%">Business</th><td>#getPersonnel.business#</td></tr>
			<tr><th>Description</th><td>#getPersonnel.desp#<br></td></tr>
			<cfif getpin2.h1B11 eq 'T'>
				<tr><td></td><td align="right">
				<a href="businesstable2.cfm?type=Delete&business=#evaluate(strNo)#">
				<img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0"> Delete</a> 
				<a href="businesstable2.cfm?type=Edit&business=#evaluate(strNo)#">
