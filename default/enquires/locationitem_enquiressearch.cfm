...
<div align="left">
<form action="locationitem_enquiressearch.cfm" method="post" target="_self">
<cfoutput>
			<h1>Search By :
		...
		<cfif isdefined("form.searchStr")>
			<cfquery dbtype="query" name="exactResult">
				Select * from TYPE where #form.searchType# = '#form.searchStr#' <cfif form.searchType eq "desp"> or despa = '#form.searchStr#'</cfif>
			</cfquery>
			
			<cfquery dbtype="query" name="similarResult">
				Select * from TYPE where #form.searchType# LIKE '%#form.searchStr#%' <cfif form.searchType eq "desp"> or despa LIKE '%#form.searchStr#%'</cfif>
			</cfquery>
		...
		<table align="center" class="data" width="600px">					
				...
				<tr>
						...
						<td>#type.price#</td>
						<td>
							<a href="locationitem_enquires.cfm?itemno1=#type.itemno#">Select</a>			
						</td>
				</tr>
