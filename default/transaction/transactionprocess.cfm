...
<cfif val(form.price) neq 0 and getGeneralInfo.editamount neq "1">
	<cfset amt1_bil=val(form.qty) * val(form.price)>
...
<cfset disamt_bil1 = numberformat(((round(val(((val(form.dispec1) / 100) * val(form.price) * -1*100)))/100)
*-1),'.__')*val(form.qty)>
<cfset netamttemp = amt1_bil - disamt_bil1>
<cfset disamt_bil2 = (numberformat((val(form.dispec2) / 100) * (val(form.price)-((val(form.dispec1) / 100) * val(form.price)))))*val(form.qty)>
<cfset netamttemp = netamttemp - disamt_bil2>
<cfset disamt_bil3 = (numberformat((val(form.dispec3) / 100) * (val(form.price)-((val(form.dispec1) / 100) * val(form.price))-((val(form.dispec2) / 100) * (val(form.price)-((val(form.dispec1) / 100) * val(form.price)))))))*val(form.qty)>
