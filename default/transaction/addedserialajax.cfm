...
<cfset batchcode = URLDecode(url.batchcode)>
        ...
        select * from iserial where type='#tran#' and refno='#nexttranno#' and trancode='#trancode#' and itemno='#itemno#' order by serialno
        </cfquery>
        ...
        <td><a href="javascript:void(0)" onClick="PopupCenter('changeserial.cfm?tran=#getremainingserialno2.type#&nexttranno=#getremainingserialno2.refno#&trancode=#getremainingserialno2.trancode#&serialno=#getremainingserialno2.serialno#','linkname','300','150');">#getremainingserialno2.serialno#</a></td>
