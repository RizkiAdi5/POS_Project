<cfif url.type1 eq "Delete">
	...
	<cfif url.multilocation eq "Y" and url.service neq "SV">
		<cfquery datasource="#dts#" name="getitem">
			...
			grade,nodisplay,title_id,title_desp<cfif lcase(hcomid) eq "topsteel_i" or lcase(hcomid) eq "topsteelhol_i">,title_despa</cfif>,
			...
			grade,nodisplay,title_id,title_desp,supp,qty1,qty2,qty3,qty4,qty5,qty6,qty7,note_a,source,job  
		</cfquery>
