...
<cfif val(getprice.price_bil) eq val(url.price)>
<cfabort>
<cfelse>
...
<cfif val(url.price) lt getitemrealprice.price>
<cfset promoitem='Y'>
...
price_bil = <cfqueryparam cfsqltype="cf_sql_double" value="#numberformat(val(url.price),stDecl_UPrice)#">,
note1='#promoitem#'
WHERE 
