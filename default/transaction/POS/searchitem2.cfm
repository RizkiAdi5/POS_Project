...
<cfset words_id_list = "121,65,120, 146, 23, 1096, 1133, 10, 1276, 965">
...
<cfset reftype= url.reftype>
   ...
   <cfif getdisplay.itemsearch_price eq 'Y'>
    <th width="50px">#words[1096]#</th>
    </cfif>
    <cfif getdisplay.itemsearch_qty eq 'Y'>
    <th width="50px">#words[1133]#</th>
    </cfif>
    </cfif>
