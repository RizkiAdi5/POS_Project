...
<!---<cfif isdefined('url.paytype')>
<cfif <!---lcase(hcomid) eq "tcds_i" and---> url.paytype eq 0 or url.paytype eq 5>
<cftry>
<div style="display:hidden">
<cfexecute
     name="C:\WINDOWS\system32\cmd.exe"
     arguments="/c c:\railo\tomcat\webapps\ROOT\default\transaction\POS\opendrawerbu.bat"
     timeout="0">
</cfexecute>
</div>
<cfcatch>
...
<cfif getgsetup.displaylogo eq 'Y'><tr><td colspan="3" align="center"><img src="\default\transaction\POS\logo.jpg" width="150" height="50"></td></tr></cfif>
...
<tr>
<td colspan="2" align="right">
SubTotal (#showcurrcode#)
</td>
<td align="right"><cfif getbill.taxincl eq "T" or getgsetup.wpitemtax eq 1>#numberformat(val(getbill.gross_bil)+val(getbill.tax_bil),'.__')#<cfelse>#numberformat(val(getbill.gross_bil),'.__')#</cfif></td>
</tr>
...
<tr>
<td colspan="2" align="right">
<cfif getbilltran.taxincl eq "T">
Before Tax Total (#showcurrcode#)
<cfelseif getbill.taxincl eq "T" >
Before Tax Total (#showcurrcode#)
<cfelse>
...
<td align="right">
<cfif getbilltran.taxincl eq "T">#numberformat(val(getbill.gross_bil),'.__')#<cfelse>#numberformat(val(getbill.net_bil),'.__')#</cfif>
</td>
</tr>
<td colspan="2" align="right"><cfif getbill.taxincl eq "T" or getbilltran.taxincl eq "T">Include </cfif>GST <cfif getgsetup.wpitemtax neq 1>(#val(getbill.taxp1)#%)</cfif></td>
...
<td>#numberformat(getperitemtax.amt,',.__')#</td>
...
this.print(false);
 $(document).keydown(function(e) {
        if(e.keyCode == 8) {
        alert("Press enter or click 'Thank you' to go back.");
        e.preventDefault(); }
    });
</script>
</cfoutput>
