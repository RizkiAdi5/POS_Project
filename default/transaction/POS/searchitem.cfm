...
<cfset words_id_list = "2069,120,757,121,123,23,122, 2070, 1096, 1133, 10, 1276, 965, 142, 2068">
...
<cfif lcase(hcomid) eq "tcds_i">
    ...
    <cfquery name="getitem" datasource="#dtssync#">
   		select itemno,aitemno,desp,ucost,price,wos_group,category,sizeid,colorid,price2,remark6,remark7,remark8,remark9,remark10,remark11 from icitem where 0=0
        ...
        and (itemno like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.itemno#%" /> 
        or aitemno like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.itemno#%" /> 
        or barcode like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.itemno#%" /> 
        )
...
<cfelse>
    ...
    <table>
    <tr>
    <td><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[120]#:</font></td>
    <td><input type="text" name="itemno1" id="itemno1" value="#url.itemno#" size="12" onfocus="clearTimeout(t2);" onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));if(event.keyCode==13){document.getElementById('itemname3').focus();}} else if (event.keyCode==40){document.getElementById('btn1').focus()}" /></td>
    <td>&nbsp;</td>
    <cfif lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "kjctrial_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "viva_i">
    <td><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[757]#:&nbsp;</font></td>
    <td> <input type="text" size="12" name="itemname2" id="itemname2" onfocus="clearTimeout(t2);" onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));if(event.keyCode==13){document.getElementById('aitemno').focus();}}  else if (event.keyCode==40){document.getElementById('btn1').focus()}" /></td>
     <td>&nbsp;</td>
    <td><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[2070]#:&nbsp;</font></td>
    <td><input type="text" size="12" name="itemname3" id="itemname3" onfocus="clearTimeout(t2);" onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));if(event.keyCode==13){document.getElementById('itemname2').focus();}} else if (event.keyCode==40){document.getElementById('btn1').focus()}" /></td><cfelse>
    <td>
    <font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[2070]#:&nbsp;</font></td>
    <td><input type="text" size="12" name="itemname3" id="itemname3" onfocus="clearTimeout(t2);" onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));if(event.keyCode==13){document.getElementById('itemname2').focus();}} else if (event.keyCode==40){document.getElementById('btn1').focus()}" /></td>
    <td>&nbsp;</td><td><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[757]#:&nbsp;</font></td><td><input type="text" size="12" name="itemname2" id="itemname2" onfocus="clearTimeout(t2);" onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));if(event.keyCode==13){document.getElementById('aitemno').focus();}}  else if (event.keyCode==40){document.getElementById('btn1').focus()}" /></td>
	
	</cfif>
    <td> &nbsp;&nbsp;<input type="button" name="gobtn1" id="gobtn1" value="#words[1276]#:" onclick="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));" onkeyup="if(event.keyCode==40){document.getElementById('btn1').focus()}"  /></td>
    </tr>
    <tr>
    ...
    <select name="group1" id="group1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));">
    ...
    <td><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#getgsetup.lmaterial#:&nbsp;&nbsp;</font></td>
     <td><input type="text" size="12" name="colorid1" id="colorid1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));"></td>
    
    <td>&nbsp;</td>
    <TD><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[122]#:&nbsp;&nbsp;</font></TD>
    ...
    <tr>
     ...
     <cfelse>
      <td><font style="text-transform:uppercase;font:'Times New Roman', Times, serif; font-size:#defaultfontsize#;">#words[121]#:&nbsp;</font></td>
     </cfif>
    <td><input type="text" size="12" name="aitemno" id="aitemno" onfocus="clearTimeout(t2);" onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielditm'),'searchitemajax.cfm?reftype=#reftype#&itemno='+escape(encodeURIComponent(document.getElementById('itemno1').value))+'&itemname='+escape(encodeURIComponent(document.getElementById('itemname3').value))+'&leftitemname='+escape(encodeURIComponent(document.getElementById('itemname2').value))+'&groupname='+escape(encodeURIComponent(document.getElementById('group1').value))+'&catename='+escape(encodeURIComponent(document.getElementById('cate1').value))+'&colorname='+escape(encodeURIComponent(document.getElementById('colorid1').value))+'&sizename='+escape(encodeURIComponent(document.getElementById('sizeid1').value))+'&brandname='+escape(encodeURIComponent(document.getElementById('brand1').value))+'&aitemno='+escape(encodeURIComponent(document.getElementById('aitemno').value)));if(event.keyCode==13){document.getElementById('gobtn1').focus();}}  else if (event.keyCode==40){document.getElementById('btn1').focus()}" /></td>
    ...
    Loading....
     ...
     <td colspan="3" align="right"> <input name="Additembtn" id="Additembtn" type="button" style="cursor:pointer;" onClick="addmultiitem();ColdFusion.Window.hide('searchitem');" value="#words[2068]#"/></td>
     </tr>
    ...
    <th width="75px"><font style="text-transform:uppercase; font-size:#defaultfontsize#">#words[120]#</font></th>
    </cfif>
    <cfif getdisplay.itemsearch_aitemno eq 'Y'><th width="100px">#words[121]#:</th></cfif>
    <cfif lcase(hcomid) eq "tcds_i">
    <th width="80px">#words[123]#:</th>
    <th width="80px">ARTIST</th>
    </cfif>
    
    <cfif getdisplay.itemsearch_desp eq 'Y'>
    <th width="200px"><font style="text-transform:uppercase; font-size:#defaultfontsize#">#words[23]#</font></th>
    </cfif>
   ...
   <cfif getdisplay.itemsearch_price eq 'Y'>
    <th width="50px"><font style="text-transform:uppercase; font-size:#defaultfontsize#">#words[1096]#</font></th>
    </cfif>
    <cfif lcase(hcomid) eq "tcds_i">
    ...
    <cfelse>
    <th width="50px"><font style="text-transform:uppercase; font-size:#defaultfontsize#">#words[1133]#</font></th>
    </cfif>
    </cfif></cfif>
    
    <cfif lcase(hcomid) neq "acht_i">
    <th width="50px"><font style="text-transform:uppercase; font-size:#defaultfontsize#">#words[10]#</font></th>
