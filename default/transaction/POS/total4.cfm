...
<form action="processprint.cfm" method="post" onsubmit="if(document.getElementById('reservebtn').checked==false){if(document.getElementById('change4').value*1 < 0){alert('Payment is not Enough');return false;}else{document.getElementById('sub_btn').disabled=true;submitpay();return false;}}else{submitpay();return false;}" name="ccform"  id="ccform">
<table width="570px" >
<tr>
...
<input type="text" name="cashc4" id="cashc4" style="font: large bolder; text-align:right" value="#numberformat(url.grandtotal,'.__')#" onkeyup="calculatetotal(event,'dbc4','')" readonly/>
</td>
</tr>
<tr>
<td colspan="3">&nbsp;
...
<td style="font-size:24px;">:</td>
<td style="font-size:24px;" align="right">
<input type="text" name="change4" id="change4" value="0.00" size="13" style="font-size:24px;font-weight: bold; text-align:right; font-family: Arial, Helvetica, sans-serif;" readonly/>
</td>
</tr>
</tr>
<tr style="display:none;">
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="right">
<input type="text" name="balanceamt4" id="balanceamt4" style="font-size:16px; text-align:right" value="#numberformat(val(url.grandtotal),'.__')#" readonly />
</td>
</tr>
<!--- <tr>
