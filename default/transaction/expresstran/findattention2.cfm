...
<cfset nametype = url.type>
    ...
    <font style="text-transform:uppercase">Attention NO.</font>&nbsp;<input type="text" name="location1" size="8" id="location1" value="" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findattention2Ajax.cfm?custno=#url.custno#&nametype=#nametype#&location='+document.getElementById('location1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value);" <cfif isdefined('url.custno')>value="#url.custno#"</cfif>  />&nbsp;MID Name:&nbsp;<input type="text" name="custname1" id="custname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findattention2Ajax.cfm?custno=#url.custno#nametype=#nametype#&location='+document.getElementById('location1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value);" size="12" />&nbsp;LEFT Name:&nbsp;<input type="text" name="custname2" id="custname2" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findattention2Ajax.cfm?custno=#url.custno#nametype=#nametype#&location='+document.getElementById('location1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value);" size="12" />&nbsp;&nbsp;<input type="button" name="Searchbtn" value="Go" >
