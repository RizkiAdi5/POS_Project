...
<cfoutput>
    ...
    <font style="text-transform:uppercase">CODE.</font>&nbsp;<input type="text" name="code1" id="code1" size="10" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielddadd'),'searchaddressajax.cfm?code='+escape(document.getElementById('code1').value)+'&addname='+escape(document.getElementById('addname1').value)+'&custno='+escape(document.getElementById('custno1').value));"  />&nbsp;NAME:&nbsp;<input type="text" size="12" name="addname1" id="addname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielddadd'),'searchaddressajax.cfm?code='+escape(document.getElementById('code1').value)+'&addname='+escape(document.getElementById('addname1').value)+'&custno='+escape(document.getElementById('custno1').value));" />&nbsp;CUSTNO:&nbsp;<input type="text" size="12" name="custno1" id="custno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFielddadd'),'searchaddressajax.cfm?code='+escape(document.getElementById('code1').value)+'&addname='+escape(document.getElementById('addname1').value)+'&custno='+escape(document.getElementById('custno1').value));" />&nbsp;&nbsp;<input type="button" name="gobtn1" value="Go"  />
