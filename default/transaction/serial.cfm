...
<!---
	...
	<body>
		...
		<tr>
			...
			<cfif sign eq 1><th>Added Serial. List</th></cfif>
		</tr>
		<cfoutput>
		<tr>
        ...
        <table class="data">
            <tr>
              <th rowspan="2" width="100px"><cfoutput>Serial</cfoutput></th>     
            ...
            <tr>
              <th><cfoutput>Serial</cfoutput> Selected</th>
        ...
        <cfif getgsetup.serialnorun eq 'Y' and (form.tran eq 'RC' or form.tran eq "OAI" or form.tran eq "CN")>
          <table class="data">
            <tr>
              <th rowspan="4" width="100px"><cfoutput>Serial</cfoutput></th>
