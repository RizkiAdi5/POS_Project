...
<td width="20px" style="font-size:16px;">:</td>
<td width="300px" align="right" style="font-size:16px;">#numberformat(url.grandtotal,',.__')#<input type="hidden" name="hidgt7" id="hidgt7" value="#numberformat(url.grandtotal,'.__')#"  /><input type="hidden" name="payamt7" id="payamt7" value="0"  /></td>
</tr>
<tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="right">
<input type="text" name="balanceamt7" id="balanceamt7" value="#numberformat(url.grandtotal,'.__')#" style="font-size:16px; text-align:right" readonly="readonly"/>
</td>
</tr>
</tr>
<tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="right">
<input type="text" name="change7" id="change7" style="font-size:16px; text-align:right" value="#numberformat(val(url.grandtotal)*-1,'.__')#" readonly="readonly" />
</td>
</tr>
<!--- <tr>
