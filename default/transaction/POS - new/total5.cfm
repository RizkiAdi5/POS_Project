...
<td style="font-size:24px;">Deposit</td>
...
<input type="radio" name="cctype15" id="cctype15" value="CUP" />CUP
</td>
</tr>
<tr <cfif getpayment.creditcard neq "Y">style="display:none" </cfif>>
...
<input type="radio" name="cctype25" id="cctype25" value="CUP" />CUP
</td>
</tr>
...
<td>Accumulated Point</td>
<td style="font-size:16px;">:</td>
<td align="right">Unable to get point<input type="hidden" name="accumpoints" id="accumpoints" value="0" readonly style="font-size:16px; text-align:right"/>
</td>
</tr>
</cfcatch></cftry>
<cfelse>
...
<input type="button" name="multivoucher" id="multivoucher" value="Multiple Voucher" onclick="PopupCenter('multivoucher.cfm?','linkname','600','1000');" />
<cfelse>
Voucher Type 
...
<tr>
<td align="center" colspan="3"><input type="button" name="sub_btn" id="sub_btn" value="Accept" onclick="if(document.getElementById('reservebtn').checked==false){
