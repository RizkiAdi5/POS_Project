<cfif isdefined("form.submit") and form.submit eq "Select #getGeneralInfo.lbatch# Code">
	<cfform name="done" action="selectbatch.cfm" method="post">
		<cfif type1 eq "Edit">
			<cfinput type="hidden" name="bmode" value="">
		<cfelse>
			<cfinput type="hidden" name="bmode" value="">
		</cfif>
		...
		<cfelse>
			<cfinput type="hidden" name="oldlocation" value="">
		</cfif>
		...
		<cfinput type="hidden" name="oldenterbatch" value="#listfirst(oldenterbatch)#">
