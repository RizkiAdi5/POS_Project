function getCredit_Card1Count()
{
	...
	if(credit_card1=="")
	{
		debt=(grand-cash-cheque-cashcd-credit_card2-telegraph_transfer-gift_voucher-dep-debit_card).toFixed(fixnum);
	}
	else if(isNaN(credit_card1))
	{
		alert("The value is not a number. Please try again");
		document.getElementById("credit_card1").value=credit_card1.substr(0,credit_card1.length-1);
		credit_card1=!isNaN(parseFloat(document.getElementById("credit_card1").value)) ? parseFloat(document.getElementById("credit_card1").value) : 0;
