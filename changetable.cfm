...
CREATE TABLE  `displaysetup2` (
 ...
 ;
    ...
    <cftry>
    <cfquery name="altertable40" datasource="main">
		    insert into menunew2 (menu_id,menu_name,menu_url,menu_level,menu_parent_id,menu_order,userpin_id) values ("10413","Cash Recording","/maintenance/cashrecordingProfile.cfm?menuID=10413","3","10400","3","h10412")
	</cfquery>
	<cfcatch type="any">
		<!---<cfoutput>#dts#-#cfcatch.Message#:#cfcatch.Detail#</cfoutput>---><br>	
	</cfcatch>
    ...
    <cftry>
    <cfquery name="altertable40" datasource="#dts#">
		       ALTER TABLE `ictrantemp` ADD COLUMN `wserialno` VARCHAR(45) DEFAULT '';
	</cfquery>
	<cfcatch type="any">
		<!---<cfoutput>#dts#-#cfcatch.Message#:#cfcatch.Detail#</cfoutput>---><br>	
	</cfcatch>
